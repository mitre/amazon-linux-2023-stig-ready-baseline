control 'AMZL-23-230517' do
  title 'Amazon Linux 2023 must mount /var/log/audit with the nodev option.'
...
defaults,nodev,nosuid,noexec 0 0'
  ...
  tag gid: 'AMZL-23-230517'
  tag rid: 'AMZL-23-230517r627750_rule'
  tag stig_id: 'AMZL-23-040129'
