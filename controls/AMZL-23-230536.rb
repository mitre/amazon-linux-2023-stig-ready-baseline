control 'AMZL-23-230536' do
  title 'Amazon Linux 2023 must not send Internet Control Message Protocol (ICMP)
redirects.'
...
IPv6.)
  desc 'check', 'Verify Amazon Linux 2023 does not IPv4 ICMP redirect messages.
...
returned, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to not allow interfaces to perform IPv4 ICMP redirects
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230536'
  tag rid: 'AMZL-23-230536r744037_rule'
  tag stig_id: 'AMZL-23-040220'
