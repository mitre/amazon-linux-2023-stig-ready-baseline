control 'AMZL-23-230310' do
  title 'Amazon Linux 2023 must disable kernel dumps unless needed.'
...
space on the target file system partition.
    ...
    Amazon Linux 2023 installation media presents the option to enable or disable the
...
the following command:
  ...
  tag gid: 'AMZL-23-230310'
  tag rid: 'AMZL-23-230310r627750_rule'
  tag stig_id: 'AMZL-23-010670'
