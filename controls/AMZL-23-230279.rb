control 'AMZL-23-230279' do
  title 'Amazon Linux 2023 must clear SLUB/SLAB objects to prevent use-after-free attacks.'
...
a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to enable poisoning of SLUB/SLAB objects with the
following commands:
...
configuration survives kernel updates:
  ...
  tag gid: 'AMZL-23-230279'
  tag rid: 'AMZL-23-230279r627750_rule'
  tag stig_id: 'AMZL-23-010423'
