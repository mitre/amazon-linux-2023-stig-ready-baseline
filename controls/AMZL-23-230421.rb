control 'AMZL-23-230421' do
  title 'Successful/unsuccessful uses of the ssh-agent in Amazon Linux 2023 must generate
an audit record.'
...
auid!=unset -k privileged-ssh
  ...
  tag gid: 'AMZL-23-230421'
  tag rid: 'AMZL-23-230421r627750_rule'
  tag stig_id: 'AMZL-23-030280'
