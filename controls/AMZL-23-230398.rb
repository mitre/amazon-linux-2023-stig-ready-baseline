control 'AMZL-23-230398' do
  title 'Amazon Linux 2023 audit logs must be group-owned by root to prevent unauthorized
read access.'
...
settings, audit reports) needed to successfully audit Amazon Linux 2023 activity.'
...
the /etc/audit/auditd.conf file:
  ...
  tag gid: 'AMZL-23-230398'
  tag rid: 'AMZL-23-230398r627750_rule'
  tag stig_id: 'AMZL-23-030090'
