control 'AMZL-23-230504' do
  title 'A Amazon Linux 2023 firewall must employ a deny-all, allow-by-exception policy
...
connections that may facilitate exfiltration of DoD data.
    ...
    Amazon Linux 2023 incorporates the "firewalld" daemon, which allows for many
...
policy for allowing connections to other systems with the following commands:
    ...
    If no zones are active on the Amazon Linux 2023 interfaces or if the target is set to
...
functionality.
  ...
  tag gid: 'AMZL-23-230504'
  tag rid: 'AMZL-23-230504r627750_rule'
  tag stig_id: 'AMZL-23-040090'
