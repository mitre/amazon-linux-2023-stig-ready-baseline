control 'AMZL-23-230520' do
  title 'Amazon Linux 2023 must mount /var/tmp with the nodev option.'
...
by adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230520'
  tag rid: 'AMZL-23-230520r627750_rule'
  tag stig_id: 'AMZL-23-040132'
