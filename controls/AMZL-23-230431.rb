control 'AMZL-23-230431' do
  title 'Successful/unsuccessful uses of userhelper in Amazon Linux 2023 must generate an
audit record.'
...
auid!=unset -k privileged-unix-update
  ...
  tag gid: 'AMZL-23-230431'
  tag rid: 'AMZL-23-230431r627750_rule'
  tag stig_id: 'AMZL-23-030315'
