control 'AMZL-23-230238' do
  title 'Amazon Linux 2023 must prevent system daemons from using Kerberos for
authentication.'
...
provide confidentiality or integrity, and DoD data may be compromised.
    ...
    Amazon Linux 2023 systems utilizing encryption are required to use FIPS-compliant
...
general-purpose computing system.'
  desc 'check', 'Verify that Amazon Linux 2023 prevents system daemons from using Kerberos for
authentication.
...
applicable.
  ...
  desc 'fix', 'Configure Amazon Linux 2023 to prevent system daemons from using Kerberos for
authentication.
  ...
  tag gid: 'AMZL-23-230238'
  tag rid: 'AMZL-23-230238r646862_rule'
  tag stig_id: 'AMZL-23-010161'
