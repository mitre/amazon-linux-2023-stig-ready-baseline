control 'AMZL-23-230531' do
  title 'The systemd Ctrl-Alt-Delete burst key sequence in Amazon Linux 2023 must be
disabled.'
...
reduced because the user will be prompted before any action is taken.'
  desc 'check', 'Verify Amazon Linux 2023 is not configured to reboot the system when Ctrl-Alt-Delete
...
file:
  ...
  tag gid: 'AMZL-23-230531'
  tag rid: 'AMZL-23-230531r627750_rule'
  tag stig_id: 'AMZL-23-040172'
