control 'AMZL-23-230477' do
  title 'Amazon Linux 2023 must have the packages required for offloading audit logs
installed.'
...
required packages with the following command:
  ...
  tag gid: 'AMZL-23-230477'
  tag rid: 'AMZL-23-230477r627750_rule'
  tag stig_id: 'AMZL-23-030670'
