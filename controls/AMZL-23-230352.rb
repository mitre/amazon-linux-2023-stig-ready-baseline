control 'AMZL-23-230352' do
  title 'Amazon Linux 2023 must automatically lock graphical user sessions after 15
...
the user session can be locked, Amazon Linux 2023 needs to provide users with the ability
...
lines:
  ...
  tag gid: 'AMZL-23-230352'
  tag rid: 'AMZL-23-230352r646876_rule'
  tag stig_id: 'AMZL-23-020060'
