control 'AMZL-23-230320' do
  title 'All Amazon Linux 2023 local interactive users must have a home directory assigned
in the /etc/passwd file.'
  desc 'If local interactive users are not assigned a valid home directory,
there is no place for the storage and control of files they should own.'
  desc 'check', "Verify local interactive users on Amazon Linux 2023 have a home directory assigned
...
8 that currently do not have a home directory assigned.'
  ...
  tag gid: 'AMZL-23-230320'
  tag rid: 'AMZL-23-230320r627750_rule'
  tag stig_id: 'AMZL-23-010720'
