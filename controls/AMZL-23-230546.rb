...
additional attack vectors.'
  desc 'check', 'Verify Amazon Linux 2023 restricts usage of ptrace to descendant processes with the
following commands:
...
returned, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to restrict usage of ptrace to descendant processes by
...
effect. To reload the contents of the files, run the following command:
  ...
  tag gid: 'AMZL-23-230546'
  tag rid: 'AMZL-23-230546r627750_rule'
  tag stig_id: 'AMZL-23-040282'
