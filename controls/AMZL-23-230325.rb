control 'AMZL-23-230325' do
  title 'All Amazon Linux 2023 local initialization files must have mode 0740 or less
permissive.'
...
"/home/smithj".
  ...
  tag gid: 'AMZL-23-230325'
  tag rid: 'AMZL-23-230325r627750_rule'
  tag stig_id: 'AMZL-23-010770'
