control 'AMZL-23-230384' do
  title 'Amazon Linux 2023 must set the umask value to 077 for all local interactive user
accounts.'
...
environment variables.)
  ...
  tag gid: 'AMZL-23-230384'
  tag rid: 'AMZL-23-230384r627750_rule'
  tag stig_id: 'AMZL-23-020352'
