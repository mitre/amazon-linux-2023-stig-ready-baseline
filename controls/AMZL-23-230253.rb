control 'AMZL-23-230253' do
  title 'Amazon Linux 2023 must ensure the SSH server uses strong entropy.'
...
The SSH service must be restarted for changes to take effect.'
  ...
  tag gid: 'AMZL-23-230253'
  tag rid: 'AMZL-23-230253r627750_rule'
  tag stig_id: 'AMZL-23-010292'
