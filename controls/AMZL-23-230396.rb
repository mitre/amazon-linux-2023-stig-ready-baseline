control 'AMZL-23-230396' do
  title 'Amazon Linux 2023 audit logs must have a mode of 0600 or less permissive to
...
configuring the log group in the /etc/audit/auditd.conf file:
  ...
  tag gid: 'AMZL-23-230396'
  tag rid: 'AMZL-23-230396r627750_rule'
  tag stig_id: 'AMZL-23-030070'
