control 'AMZL-23-244536' do
  title 'Amazon Linux 2023 must disable the user list at logon for graphical user
interfaces.'
...
file should be created under the appropriate subdirectory.
  ...
  tag gid: 'AMZL-23-244536'
  tag rid: 'AMZL-23-244536r743857_rule'
  tag stig_id: 'AMZL-23-020032'
