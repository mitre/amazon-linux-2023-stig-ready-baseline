control 'AMZL-23-230377' do
  title 'Amazon Linux 2023 must prevent the use of dictionary words for passwords.'
  desc 'If Amazon Linux 2023 allows the user to select passwords based on dictionary
...
opportunity for successful guesses, and brute-force attacks.'
  desc 'check', 'Verify Amazon Linux 2023 prevents the use of dictionary words for passwords.
...
the "dictcheck" parameter:
  ...
  tag gid: 'AMZL-23-230377'
  tag rid: 'AMZL-23-230377r627750_rule'
  tag stig_id: 'AMZL-23-020300'
