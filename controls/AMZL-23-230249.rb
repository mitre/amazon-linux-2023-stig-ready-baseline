control 'AMZL-23-230249' do
  title 'The Amazon Linux 2023 /var/log directory must be owned by root.'
...
command:
  ...
  tag gid: 'AMZL-23-230249'
  tag rid: 'AMZL-23-230249r627750_rule'
  tag stig_id: 'AMZL-23-010250'
