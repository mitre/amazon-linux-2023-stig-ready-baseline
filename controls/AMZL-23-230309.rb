control 'AMZL-23-230309' do
  title 'Local Amazon Linux 2023 initialization files must not execute world-writable
programs.'
...
the following command:
  ...
  tag gid: 'AMZL-23-230309'
  tag rid: 'AMZL-23-230309r627750_rule'
  tag stig_id: 'AMZL-23-010660'
