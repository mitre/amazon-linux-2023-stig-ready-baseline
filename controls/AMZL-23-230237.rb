control 'AMZL-23-230237' do
  title 'The Amazon Linux 2023 pam_unix.so module must be configured in the password-auth
...
/etc/pam.d/password-auth with the following command:
  ...
  desc 'fix', 'Configure Amazon Linux 2023 to use a FIPS 140-2 approved cryptographic hashing
...
include the sha512 option for pam_unix.so:
  ...
  tag gid: 'AMZL-23-230237'
  tag rid: 'AMZL-23-230237r743931_rule'
  tag stig_id: 'AMZL-23-010160'
