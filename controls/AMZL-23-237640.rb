control 'AMZL-23-237640' do
  title 'The krb5-server package must not be installed on Amazon Linux 2023.'
...
requirement or remove it from the system with the following command:
  ...
  tag gid: 'AMZL-23-237640'
  tag rid: 'AMZL-23-237640r646890_rule'
  tag stig_id: 'AMZL-23-010163'
