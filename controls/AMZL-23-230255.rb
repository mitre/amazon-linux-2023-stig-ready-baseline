...
finding.'
  desc 'fix', 'Configure the Amazon Linux 2023 OpenSSL library to use only DoD-approved TLS
...
"/etc/crypto-policies/back-ends/opensslcnf.config" file:
  ...
  tag gid: 'AMZL-23-230255'
  tag rid: 'AMZL-23-230255r627750_rule'
  tag stig_id: 'AMZL-23-010294'
