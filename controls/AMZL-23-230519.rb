control 'AMZL-23-230519' do
  title 'Amazon Linux 2023 must mount /var/log/audit with the noexec option.'
...
defaults,nodev,nosuid,noexec 0 0'
  ...
  tag gid: 'AMZL-23-230519'
  tag rid: 'AMZL-23-230519r627750_rule'
  tag stig_id: 'AMZL-23-040131'
