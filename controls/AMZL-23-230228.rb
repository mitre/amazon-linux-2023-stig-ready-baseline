control 'AMZL-23-230228' do
  title 'All Amazon Linux 2023 remote access methods must be monitored.'
...
servers, workstations, notebook computers, smartphones, and tablets).'
  desc 'check', %q(Verify that Amazon Linux 2023 monitors all remote access methods.
...
logged, this is a finding.)
  desc 'fix', 'Configure Amazon Linux 2023 to monitor all remote access methods by installing rsyslog
...
To restart the "rsyslog" service, run the following command:
  ...
  tag gid: 'AMZL-23-230228'
  tag rid: 'AMZL-23-230228r627750_rule'
  tag stig_id: 'AMZL-23-010070'
