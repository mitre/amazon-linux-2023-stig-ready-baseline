control 'AMZL-23-230321' do
  title 'All Amazon Linux 2023 local interactive user home directories must have mode 0750
or less permissive.'
...
command:
  ...
  tag gid: 'AMZL-23-230321'
  tag rid: 'AMZL-23-230321r627750_rule'
  tag stig_id: 'AMZL-23-010730'
