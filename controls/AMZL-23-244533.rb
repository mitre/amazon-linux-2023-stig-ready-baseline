control 'AMZL-23-244533' do
  title 'Amazon Linux 2023 must configure the use of the pam_faillock.so module in the
...
to match the following lines:
  ...
  tag gid: 'AMZL-23-244533'
  tag rid: 'AMZL-23-244533r743848_rule'
  tag stig_id: 'AMZL-23-020025'
