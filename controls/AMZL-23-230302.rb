control 'AMZL-23-230302' do
  title 'Amazon Linux 2023 must prevent code from being executed on file systems that
...
file systems that contain user home directories for interactive users.'
  ...
  tag gid: 'AMZL-23-230302'
  tag rid: 'AMZL-23-230302r627750_rule'
  tag stig_id: 'AMZL-23-010590'
