control 'AMZL-23-230537' do
  title 'Amazon Linux 2023 must not respond to Internet Control Message Protocol (ICMP)
...
Requirements", which resulted in this difference between IPv4 and IPv6.'
  desc 'check', 'Verify Amazon Linux 2023 does not respond to ICMP echoes sent to a broadcast address.
...
returned, or the retuned line is commented out, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to not respond to IPv4 ICMP echoes sent to a broadcast
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230537'
  tag rid: 'AMZL-23-230537r744039_rule'
  tag stig_id: 'AMZL-23-040230'
