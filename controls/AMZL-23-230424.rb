control 'AMZL-23-230424' do
  title 'Successful/unsuccessful uses of the umount command in Amazon Linux 2023 must
...
auid!=unset -k privileged-mount
  ...
  tag gid: 'AMZL-23-230424'
  tag rid: 'AMZL-23-230424r627750_rule'
  tag stig_id: 'AMZL-23-030301'
