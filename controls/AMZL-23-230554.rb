control 'AMZL-23-230554' do
  title 'Amazon Linux 2023 network interfaces must not be in promiscuous mode.'
...
by the ISSO and documented.
  ...
  tag gid: 'AMZL-23-230554'
  tag rid: 'AMZL-23-230554r627750_rule'
  tag stig_id: 'AMZL-23-040330'
