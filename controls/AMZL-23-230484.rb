control 'AMZL-23-230484' do
  title 'Amazon Linux 2023 must securely compare internal information system clocks at
...
https://www.usno.navy.mil/USNO/time/ntp/dod-customers for more information.'
  desc 'check', 'Verify Amazon Linux 2023 is securely comparing internal information system clocks at
...
the following line in the /etc/chrony.conf file.
  ...
  tag gid: 'AMZL-23-230484'
  tag rid: 'AMZL-23-230484r627750_rule'
  tag stig_id: 'AMZL-23-030740'
