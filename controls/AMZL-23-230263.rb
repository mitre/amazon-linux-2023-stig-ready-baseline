control 'AMZL-23-230263' do
  title 'The Amazon Linux 2023 file integrity tool must notify the system administrator
...
detection.
    ...
    Amazon Linux 2023 comes with many optional software packages. A file integrity tool
...
checks are performed on the system.
    ...
    Check that Amazon Linux 2023 routinely executes a file integrity scan for changes to
...
check run" root@sysname.mil'
  ...
  tag gid: 'AMZL-23-230263'
  tag rid: 'AMZL-23-230263r627750_rule'
  tag stig_id: 'AMZL-23-010360'
