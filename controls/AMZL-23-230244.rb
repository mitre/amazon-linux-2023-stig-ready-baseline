...
If conflicting results are returned, this is a finding.'
  desc 'fix', 'Note: This setting must be applied in conjunction with AMZL-23-010201 to function correctly.
...
For the changes to take effect, the SSH daemon must be restarted:
  ...
  tag gid: 'AMZL-23-230244'
  tag rid: 'AMZL-23-230244r917867_rule'
  tag stig_id: 'AMZL-23-010200'
