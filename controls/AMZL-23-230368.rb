control 'AMZL-23-230368' do
  title 'Amazon Linux 2023 passwords must be prohibited from reuse for a minimum of five
generations.'
...
result is a password that is not changed per policy requirements.
    ...
    Amazon Linux 2023 utilizes "pwquality" consecutively as a mechanism to enforce
...
"/etc/pam.d/password-auth" (or modify the line to have the required value):
  ...
  tag gid: 'AMZL-23-230368'
  tag rid: 'AMZL-23-230368r627750_rule'
  tag stig_id: 'AMZL-23-020220'
