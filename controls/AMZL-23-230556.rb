control 'AMZL-23-230556' do
  title 'The Amazon Linux 2023 SSH daemon must prevent remote hosts from connecting to the
proxy display.'
...
is provided by a third-party vendor):
  ...
  tag gid: 'AMZL-23-230556'
  tag rid: 'AMZL-23-230556r627750_rule'
  tag stig_id: 'AMZL-23-040341'
