control 'AMZL-23-244543' do
  title 'Amazon Linux 2023 must notify the System Administrator (SA) and Information
...
storage capacity expansion.'
  desc 'check', 'Verify Amazon Linux 2023 notifies the SA and ISSO (at a minimum) when allocated audit
...
adding/modifying the following line in the /etc/audit/auditd.conf file.
  ...
  tag gid: 'AMZL-23-244543'
  tag rid: 'AMZL-23-244543r743878_rule'
  tag stig_id: 'AMZL-23-030731'
