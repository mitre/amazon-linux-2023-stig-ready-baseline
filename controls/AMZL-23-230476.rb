control 'AMZL-23-230476' do
  title 'Amazon Linux 2023 must allocate audit record storage capacity to store at least
one week of audit records, when audit records are not immediately sent to a
central audit record storage facility.'
  desc 'To ensure Amazon Linux 2023 systems have a sufficient storage capacity in which
to write the audit logs, Amazon Linux 2023 needs to be able to allocate audit record
storage capacity.

    The task of allocating audit record storage capacity is usually performed
during initial installation of Amazon Linux 2023.'
  desc 'check', 'Verify Amazon Linux 2023 allocates audit record storage capacity to store at least one
...
records, a new partition with sufficient space will need be to be created.'
  ...
  tag gid: 'AMZL-23-230476'
  tag rid: 'AMZL-23-230476r627750_rule'
  tag stig_id: 'AMZL-23-030660'
