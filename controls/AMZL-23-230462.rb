control 'AMZL-23-230462' do
  title 'Successful/unsuccessful uses of the sudo command in Amazon Linux 2023 must
...
-k priv_cmd
  ...
  tag gid: 'AMZL-23-230462'
  tag rid: 'AMZL-23-230462r627750_rule'
  tag stig_id: 'AMZL-23-030550'
