control 'AMZL-23-230495' do
  title 'Amazon Linux 2023 must disable the controller area network (CAN) protocol.'
...
Reboot the system for the settings to take effect.'
  ...
  tag gid: 'AMZL-23-230495'
  tag rid: 'AMZL-23-230495r792914_rule'
  tag stig_id: 'AMZL-23-040022'
