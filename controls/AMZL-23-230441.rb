control 'AMZL-23-230441' do
  title "Successful/unsuccessful uses of the rmdir command in Amazon Linux 2023 must
...
following rules in the \"/etc/audit/rules.d/audit.rules\" file:
  ...
  tag gid: 'AMZL-23-230441'
  tag rid: 'AMZL-23-230441r627750_rule'
  tag stig_id: 'AMZL-23-030363'
