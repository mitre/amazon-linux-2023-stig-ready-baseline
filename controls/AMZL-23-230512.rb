control 'AMZL-23-230512' do
  title 'Amazon Linux 2023 must mount /tmp with the nosuid option.'
...
adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230512'
  tag rid: 'AMZL-23-230512r627750_rule'
  tag stig_id: 'AMZL-23-040124'
