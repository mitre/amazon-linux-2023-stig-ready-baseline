control 'AMZL-23-244539' do
  title 'Amazon Linux 2023 must prevent a user from overriding the screensaver
...
file should be created under the appropriate subdirectory.
  ...
  tag gid: 'AMZL-23-244539'
  tag rid: 'AMZL-23-244539r743866_rule'
  tag stig_id: 'AMZL-23-020082'
