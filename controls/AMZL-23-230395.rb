control 'AMZL-23-230395' do
  title 'Amazon Linux 2023 must resolve audit information before writing to disk.'
...
more difficult.'
  desc 'check', 'Verify the Amazon Linux 2023 Audit Daemon is configured to resolve audit information
...
option:
  ...
  tag gid: 'AMZL-23-230395'
  tag rid: 'AMZL-23-230395r627750_rule'
  tag stig_id: 'AMZL-23-030063'
