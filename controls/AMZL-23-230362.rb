control 'AMZL-23-230362' do
  title 'Amazon Linux 2023 must require the change of at least four character classes when
...
compromised.
    ...
    Amazon Linux 2023 utilizes "pwquality" as a mechanism to enforce password
...
the line to have the required value):
  ...
  tag gid: 'AMZL-23-230362'
  tag rid: 'AMZL-23-230362r627750_rule'
  tag stig_id: 'AMZL-23-020160'
