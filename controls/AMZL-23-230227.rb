control 'AMZL-23-230227' do
  title 'Amazon Linux 2023 must display the Standard Mandatory DoD Notice and Consent
...
Agreement for details."'
  desc 'check', 'Verify Amazon Linux 2023 displays the Standard Mandatory DoD Notice and Consent Banner
before granting access to the operating system via a command line user logon.

    Check that Amazon Linux 2023 displays a banner at the command line login screen with
...
Consent Banner exactly, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to display the Standard Mandatory DoD Notice and Consent
...
Agreement for details."'
  ...
  tag gid: 'AMZL-23-230227'
  tag rid: 'AMZL-23-230227r627750_rule'
  tag stig_id: 'AMZL-23-010060'
