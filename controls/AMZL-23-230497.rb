control 'AMZL-23-230497' do
  title 'Amazon Linux 2023 must disable the transparent inter-process communication (TIPC)
protocol.'
...
Reboot the system for the settings to take effect.'
  ...
  tag gid: 'AMZL-23-230497'
  tag rid: 'AMZL-23-230497r792920_rule'
  tag stig_id: 'AMZL-23-040024'
