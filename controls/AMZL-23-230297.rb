control 'AMZL-23-230297' do
  title 'The auditd service must be running in Amazon Linux 2023.'
...
commands:
  ...
  tag gid: 'AMZL-23-230297'
  tag rid: 'AMZL-23-230297r627750_rule'
  tag stig_id: 'AMZL-23-010560'
