control 'AMZL-23-230438' do
  title 'Successful/unsuccessful uses of the init_module command in Amazon Linux 2023 must
...
module_chng
  ...
  tag gid: 'AMZL-23-230438'
  tag rid: 'AMZL-23-230438r627750_rule'
  tag stig_id: 'AMZL-23-030360'
