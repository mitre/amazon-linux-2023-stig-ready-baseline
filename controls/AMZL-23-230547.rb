...
additional attack vectors.'
  desc 'check', 'Verify Amazon Linux 2023 restricts exposed kernel pointer addresses access with the
following commands:
...
returned, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to restrict exposed kernel pointer addresses access by
...
effect. To reload the contents of the files, run the following command:
  ...
  tag gid: 'AMZL-23-230547'
  tag rid: 'AMZL-23-230547r627750_rule'
  tag stig_id: 'AMZL-23-040283'
