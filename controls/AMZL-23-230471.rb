control 'AMZL-23-230471' do
  title 'Amazon Linux 2023 must allow only the Information System Security Manager (ISSM)
...
commands:
  ...
  tag gid: 'AMZL-23-230471'
  tag rid: 'AMZL-23-230471r627750_rule'
  tag stig_id: 'AMZL-23-030610'
