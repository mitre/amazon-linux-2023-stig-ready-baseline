control 'AMZL-23-230330' do
  title 'Amazon Linux 2023 must not allow users to override SSH environment variables.'
...
is commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to allow the SSH daemon to not allow unattended or
...
the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-230330'
  tag rid: 'AMZL-23-230330r646870_rule'
  tag stig_id: 'AMZL-23-010830'
