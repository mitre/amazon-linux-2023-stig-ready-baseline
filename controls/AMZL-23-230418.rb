control 'AMZL-23-230418' do
  title 'Successful/unsuccessful uses of the chage command in Amazon Linux 2023 must
...
auid!=unset -k privileged-chage
  ...
  tag gid: 'AMZL-23-230418'
  tag rid: 'AMZL-23-230418r627750_rule'
  tag stig_id: 'AMZL-23-030250'
