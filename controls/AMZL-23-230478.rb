control 'AMZL-23-230478' do
  title 'Amazon Linux 2023 must have the packages required for encrypting offloaded audit
logs installed.'
...
installing the required packages with the following command:
  ...
  tag gid: 'AMZL-23-230478'
  tag rid: 'AMZL-23-230478r744011_rule'
  tag stig_id: 'AMZL-23-030680'
