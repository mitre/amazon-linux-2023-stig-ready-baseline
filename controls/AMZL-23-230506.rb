control 'AMZL-23-230506' do
  title 'Amazon Linux 2023 wireless network adapters must be disabled.'
...
following command:
  ...
  tag gid: 'AMZL-23-230506'
  tag rid: 'AMZL-23-230506r627750_rule'
  tag stig_id: 'AMZL-23-040110'
