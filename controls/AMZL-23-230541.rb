control 'AMZL-23-230541' do
  title 'Amazon Linux 2023 must not accept router advertisements on all IPv6 interfaces.'
...
lines in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230541'
  tag rid: 'AMZL-23-230541r627750_rule'
  tag stig_id: 'AMZL-23-040261'
