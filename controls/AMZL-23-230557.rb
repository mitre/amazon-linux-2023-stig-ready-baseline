control 'AMZL-23-230557' do
  title 'If the Trivial File Transfer Protocol (TFTP) server is required, the
Amazon Linux 2023 TFTP daemon must be configured to operate in secure mode.'
...
line to "/etc/xinetd.d/tftp" (or modify the line to have the required value):
  ...
  tag gid: 'AMZL-23-230557'
  tag rid: 'AMZL-23-230557r627750_rule'
  tag stig_id: 'AMZL-23-040350'
