control 'AMZL-23-230243' do
  title 'A sticky bit must be set on all Amazon Linux 2023 public directories to prevent
...
sticky bit:
  ...
  tag gid: 'AMZL-23-230243'
  tag rid: 'AMZL-23-230243r627750_rule'
  tag stig_id: 'AMZL-23-010190'
