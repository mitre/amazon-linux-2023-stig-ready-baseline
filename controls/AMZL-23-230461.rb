control 'AMZL-23-230461' do
  title "Successful/unsuccessful uses of the fchmod system call in Amazon Linux 2023 must
...
perm_mod
  ...
  tag gid: 'AMZL-23-230461'
  tag rid: 'AMZL-23-230461r627750_rule'
  tag stig_id: 'AMZL-23-030540'
