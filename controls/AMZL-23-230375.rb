control 'AMZL-23-230375' do
  title 'All Amazon Linux 2023 passwords must contain at least one special character.'
...
to have the required value):
  ...
  tag gid: 'AMZL-23-230375'
  tag rid: 'AMZL-23-230375r627750_rule'
  tag stig_id: 'AMZL-23-020280'
