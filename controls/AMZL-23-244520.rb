control 'AMZL-23-244520' do
  title "The Amazon Linux 2023 system-auth file must be configured to use a sufficient
...
finding.
  "
  desc 'fix', "
    Configure Amazon Linux 2023 to encrypt all stored passwords with a strong
cryptographic hash.
...
set \"rounds\" to a value no lower than \"5000\":
  ...
  tag gid: 'AMZL-23-244520'
  tag rid: 'AMZL-23-244520r743809_rule'
  tag stig_id: 'AMZL-23-010131'
