control 'AMZL-23-230448' do
  title 'Successful/unsuccessful uses of the chsh command in Amazon Linux 2023 must
...
-k priv_cmd
  ...
  tag gid: 'AMZL-23-230448'
  tag rid: 'AMZL-23-230448r627750_rule'
  tag stig_id: 'AMZL-23-030410'
