control 'AMZL-23-230435' do
  title 'Successful/unsuccessful uses of the setfacl command in Amazon Linux 2023 must
...
auid!=unset -k perm_mod
  ...
  tag gid: 'AMZL-23-230435'
  tag rid: 'AMZL-23-230435r627750_rule'
  tag stig_id: 'AMZL-23-030330'
