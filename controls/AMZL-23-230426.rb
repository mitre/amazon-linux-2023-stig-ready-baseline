control 'AMZL-23-230426' do
  title 'Successful/unsuccessful uses of the unix_update in Amazon Linux 2023 must
...
auid!=unset -k privileged-unix-update
  ...
  tag gid: 'AMZL-23-230426'
  tag rid: 'AMZL-23-230426r627750_rule'
  tag stig_id: 'AMZL-23-030310'
