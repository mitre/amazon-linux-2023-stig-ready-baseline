control 'AMZL-23-244552' do
  title 'Amazon Linux 2023 must not forward IPv4 source-routed packets by default.'
...
forwarding is enabled and the system is functioning as a router.'
  desc 'check', 'Verify Amazon Linux 2023 does not accept IPv4 source-routed packets by default.
...
returned, or the line is commented out, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to not forward IPv4 source-routed packets by default with
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-244552'
  tag rid: 'AMZL-23-244552r743905_rule'
  tag stig_id: 'AMZL-23-040249'
