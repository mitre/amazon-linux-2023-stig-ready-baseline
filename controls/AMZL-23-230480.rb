control 'AMZL-23-230480' do
  title 'Amazon Linux 2023 must take appropriate action when the internal event queue is
full.'
...
"overflow_action" option:
  ...
  tag gid: 'AMZL-23-230480'
  tag rid: 'AMZL-23-230480r627750_rule'
  tag stig_id: 'AMZL-23-030700'
