control 'AMZL-23-230307' do
  title 'Amazon Linux 2023 must prevent special devices on file systems that are imported
...
file systems that are being imported via NFS.'
  ...
  tag gid: 'AMZL-23-230307'
  tag rid: 'AMZL-23-230307r627750_rule'
  tag stig_id: 'AMZL-23-010640'
