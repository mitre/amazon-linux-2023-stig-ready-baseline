control 'AMZL-23-230467' do
  title 'Successful/unsuccessful modifications to the lastlog file in Amazon Linux 2023
...
all direct access to the information system;
  ...
  desc 'check', 'Verify Amazon Linux 2023 generates an audit record when successful/unsuccessful
...
updating the following rules in the "/etc/audit/rules.d/audit.rules" file:
  ...
  tag gid: 'AMZL-23-230467'
  tag rid: 'AMZL-23-230467r627750_rule'
  tag stig_id: 'AMZL-23-030600'
