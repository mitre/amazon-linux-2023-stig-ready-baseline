control 'AMZL-23-230403' do
  title 'Amazon Linux 2023 audit system must protect logon UIDs from unauthorized change.'
...
the following line to "/etc/audit/rules.d/audit.rules"
  ...
  tag gid: 'AMZL-23-230403'
  tag rid: 'AMZL-23-230403r627750_rule'
  tag stig_id: 'AMZL-23-030122'
