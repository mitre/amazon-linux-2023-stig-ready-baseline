control 'AMZL-23-230422' do
  title 'Successful/unsuccessful uses of the passwd command in Amazon Linux 2023 must
...
auid!=unset -k privileged-passwd
  ...
  tag gid: 'AMZL-23-230422'
  tag rid: 'AMZL-23-230422r627750_rule'
  tag stig_id: 'AMZL-23-030290'
