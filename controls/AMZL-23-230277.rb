control 'AMZL-23-230277' do
  title 'Amazon Linux 2023 must clear the page allocator to prevent use-after-free
attacks.'
...
is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to enable page poisoning with the following commands:
...
configuration survives kernel updates:
  ...
  tag gid: 'AMZL-23-230277'
  tag rid: 'AMZL-23-230277r627750_rule'
  tag stig_id: 'AMZL-23-010421'
