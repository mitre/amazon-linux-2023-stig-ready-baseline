control 'AMZL-23-230231' do
  title 'Amazon Linux 2023 must encrypt all stored passwords with a FIPS 140-2 approved
...
following command:
  ...
  desc 'fix', 'Configure Amazon Linux 2023 to encrypt all stored passwords.
...
"[ENCRYPT_METHOD]" to SHA512.
  ...
  tag gid: 'AMZL-23-230231'
  tag rid: 'AMZL-23-230231r627750_rule'
  tag stig_id: 'AMZL-23-010110'
