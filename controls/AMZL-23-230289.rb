control 'AMZL-23-230289' do
  title "The Amazon Linux 2023 SSH daemon must not allow compression or must only allow
...
value to \"delayed\" or \"no\":
  ...
  tag gid: 'AMZL-23-230289'
  tag rid: 'AMZL-23-230289r743954_rule'
  tag stig_id: 'AMZL-23-010510'
