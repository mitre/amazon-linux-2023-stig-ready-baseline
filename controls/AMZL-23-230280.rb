control 'AMZL-23-230280' do
  title 'Amazon Linux 2023 must implement address space layout randomization (ASLR) to
...
hardware providing the greater strength of mechanism.
  ...
  desc 'check', 'Verify Amazon Linux 2023 implements ASLR with the following command:
...
line to "/etc/sysctl.d/*.conf"(or modify the line to have the required value):
  ...
  tag gid: 'AMZL-23-230280'
  tag rid: 'AMZL-23-230280r627750_rule'
  tag stig_id: 'AMZL-23-010430'
