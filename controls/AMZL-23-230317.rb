control 'AMZL-23-230317' do
  title 'Executable search paths within the initialization files of all local
interactive Amazon Linux 2023 users must only contain paths that resolve to the system
...
directory owned by the application, it must be documented with the ISSO.'
  ...
  tag gid: 'AMZL-23-230317'
  tag rid: 'AMZL-23-230317r627750_rule'
  tag stig_id: 'AMZL-23-010690'
