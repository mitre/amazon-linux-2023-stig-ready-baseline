control 'AMZL-23-230505' do
  title 'A firewall must be installed on Amazon Linux 2023.'
...
example, dial-up, broadband, and wireless.
    ...
    Amazon Linux 2023 functionality (e.g., RDP) must be capable of taking enforcement
...
$ sudo yum install firewalld.noarch'
  ...
  tag gid: 'AMZL-23-230505'
  tag rid: 'AMZL-23-230505r744020_rule'
  tag stig_id: 'AMZL-23-040100'
