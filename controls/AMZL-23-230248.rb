control 'AMZL-23-230248' do
  title 'The Amazon Linux 2023 /var/log directory must have mode 0755 or less permissive.'
...
the following command:
  ...
  tag gid: 'AMZL-23-230248'
  tag rid: 'AMZL-23-230248r627750_rule'
  tag stig_id: 'AMZL-23-010240'
