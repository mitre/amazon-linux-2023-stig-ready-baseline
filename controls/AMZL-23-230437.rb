control 'AMZL-23-230437' do
  title 'Successful/unsuccessful uses of the newgrp command in Amazon Linux 2023 must
...
auid!=unset -k priv_cmd
  ...
  tag gid: 'AMZL-23-230437'
  tag rid: 'AMZL-23-230437r627750_rule'
  tag stig_id: 'AMZL-23-030350'
