control 'AMZL-23-230278' do
  title 'Amazon Linux 2023 must disable virtual syscalls.'
...
configuration survives kernel updates:
  ...
  tag gid: 'AMZL-23-230278'
  tag rid: 'AMZL-23-230278r743948_rule'
  tag stig_id: 'AMZL-23-010422'
