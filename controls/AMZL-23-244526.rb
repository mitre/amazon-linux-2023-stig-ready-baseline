control 'AMZL-23-244526' do
  title 'The Amazon Linux 2023 SSH daemon must be configured to use system-wide crypto
policies.'
...
If the "crypto_policy" is uncommented, this is a finding.'
  desc 'fix', 'Configure the Amazon Linux 2023 SSH daemon to use system-wide crypto policies by
adding the following line to /etc/sysconfig/sshd:
  ...
  tag gid: 'AMZL-23-244526'
  tag rid: 'AMZL-23-244526r743827_rule'
  tag stig_id: 'AMZL-23-010287'
