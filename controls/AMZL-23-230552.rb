control 'AMZL-23-230552' do
  title 'The Amazon Linux 2023 file integrity tool must be configured to verify Access
Control Lists (ACLs).'
...
directory selection lists.'
  ...
  tag gid: 'AMZL-23-230552'
  tag rid: 'AMZL-23-230552r627750_rule'
  tag stig_id: 'AMZL-23-040310'
