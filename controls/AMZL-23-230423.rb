control 'AMZL-23-230423' do
  title 'Successful/unsuccessful uses of the mount command in Amazon Linux 2023 must
...
auid!=unset -k privileged-mount
  ...
  tag gid: 'AMZL-23-230423'
  tag rid: 'AMZL-23-230423r627750_rule'
  tag stig_id: 'AMZL-23-030300'
