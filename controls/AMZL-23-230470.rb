control 'AMZL-23-230470' do
  title 'Amazon Linux 2023 must enable Linux audit logging for the USBGuard daemon.'
...
all direct access to the information system;
  ...
  desc 'check', 'Verify Amazon Linux 2023 enables Linux audit logging of the USBGuard daemon with the
following commands:
...
the line is commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to enable Linux audit logging of the USBGuard daemon by
...
"/etc/usbguard/usbguard-daemon.conf":
  ...
  tag gid: 'AMZL-23-230470'
  tag rid: 'AMZL-23-230470r744006_rule'
  tag stig_id: 'AMZL-23-030603'
