control 'AMZL-23-230311' do
  title 'Amazon Linux 2023 must disable the kernel.core_pattern.'
  desc 'It is detrimental for operating systems to provide, or install by
default, functionality exceeding requirements or mission objectives. These
unnecessary capabilities or services are often overlooked and therefore may
remain unsecured. They increase the risk to the platform by providing
additional attack vectors.'
  desc 'check', 'Verify Amazon Linux 2023 disables storing core dumps with the following commands:
...
System Security Officer (ISSO) as an operational requirement, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to disable storing core dumps by adding the following line
...
effect. To reload the contents of the files, run the following command:
  ...
  tag gid: 'AMZL-23-230311'
  tag rid: 'AMZL-23-230311r627750_rule'
  tag stig_id: 'AMZL-23-010671'
