control 'AMZL-23-230394' do
  title 'Amazon Linux 2023 must label all off-loaded audit logs before sending them to the
central log server.'
...
correct system.'
  desc 'check', 'Verify the Amazon Linux 2023 Audit Daemon is configured to label all off-loaded audit
...
option:
  ...
  tag gid: 'AMZL-23-230394'
  tag rid: 'AMZL-23-230394r627750_rule'
  tag stig_id: 'AMZL-23-030062'
