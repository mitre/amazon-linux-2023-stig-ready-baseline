control 'AMZL-23-230425' do
  title 'Successful/unsuccessful uses of the mount syscall in Amazon Linux 2023 must
...
privileged-mount
  ...
  tag gid: 'AMZL-23-230425'
  tag rid: 'AMZL-23-230425r627750_rule'
  tag stig_id: 'AMZL-23-030302'
