control 'AMZL-23-230305' do
  title 'Amazon Linux 2023 must prevent files with the setuid and setgid bit set from
...
file systems that are associated with removable media.'
  ...
  tag gid: 'AMZL-23-230305'
  tag rid: 'AMZL-23-230305r627750_rule'
  tag stig_id: 'AMZL-23-010620'
