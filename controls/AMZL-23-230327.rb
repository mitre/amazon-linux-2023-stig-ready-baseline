control 'AMZL-23-230327' do
  title 'All Amazon Linux 2023 local files and directories must have a valid group owner.'
...
without a valid group owner.'
  desc 'check', 'Verify all local files and directories on Amazon Linux 2023 have a valid group with
...
directories.'
  desc 'fix', 'Either remove all files and directories from Amazon Linux 2023 that do not have a
...
with the "chgrp" command:
  ...
  tag gid: 'AMZL-23-230327'
  tag rid: 'AMZL-23-230327r627750_rule'
  tag stig_id: 'AMZL-23-010790'
