control 'AMZL-23-237642' do
  title %q(Amazon Linux 2023 must use the invoking user's password for privilege escalation
when using "sudo".)
...
configuration file in the /etc/sudoers.d/ directory:
  ...
  tag gid: 'AMZL-23-237642'
  tag rid: 'AMZL-23-237642r646896_rule'
  tag stig_id: 'AMZL-23-010383'
