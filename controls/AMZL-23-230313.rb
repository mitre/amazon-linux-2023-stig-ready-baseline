control 'AMZL-23-230313' do
  title 'Amazon Linux 2023 must disable core dumps for all users.'
...
".conf" file defined in /etc/security/limits.d/:
  ...
  tag gid: 'AMZL-23-230313'
  tag rid: 'AMZL-23-230313r627750_rule'
  tag stig_id: 'AMZL-23-010673'
