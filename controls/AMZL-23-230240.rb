control 'AMZL-23-230240' do
  title 'Amazon Linux 2023 must use a Linux Security Module configured to enforce limits
on system services.'
...
"/etc/selinux/config" file to have the following line:
  ...
  tag gid: 'AMZL-23-230240'
  tag rid: 'AMZL-23-230240r627750_rule'
  tag stig_id: 'AMZL-23-010170'
