control 'AMZL-23-230433' do
  title 'Successful/unsuccessful uses of unix_chkpwd in Amazon Linux 2023 must generate an
audit record.'
...
auid!=unset -k privileged-unix-update
  ...
  tag gid: 'AMZL-23-230433'
  tag rid: 'AMZL-23-230433r627750_rule'
  tag stig_id: 'AMZL-23-030317'
