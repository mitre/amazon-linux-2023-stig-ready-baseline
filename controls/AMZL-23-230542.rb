control 'AMZL-23-230542' do
  title 'Amazon Linux 2023 must not accept router advertisements on all IPv6 interfaces by
default.'
...
attack.'
  desc 'check', 'Verify Amazon Linux 2023 does not accept router advertisements on all IPv6 interfaces
...
is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to not accept router advertisements on all IPv6 interfaces
...
lines in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230542'
  tag rid: 'AMZL-23-230542r627750_rule'
  tag stig_id: 'AMZL-23-040262'
