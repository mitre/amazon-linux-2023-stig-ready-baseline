control 'AMZL-23-230523' do
  title 'The Amazon Linux 2023 fapolicy module must be installed.'
...
not namespace aware and can cause issues when launching or running containers.'
  desc 'check', 'Verify the Amazon Linux 2023 "fapolicyd" is installed.
...
$ sudo yum install fapolicyd.x86_64'
  ...
  tag gid: 'AMZL-23-230523'
  tag rid: 'AMZL-23-230523r744023_rule'
  tag stig_id: 'AMZL-23-040135'
