control 'AMZL-23-230485' do
  title 'Amazon Linux 2023 must disable the chrony daemon from acting as a server.'
...
https://www.usno.navy.mil/USNO/time/ntp/dod-customers for more information.'
  desc 'check', %q(Verify Amazon Linux 2023 disables the chrony daemon from acting as a server with the
following command:
...
a server by adding/modifying the following line in the /etc/chrony.conf file.
  ...
  tag gid: 'AMZL-23-230485'
  tag rid: 'AMZL-23-230485r627750_rule'
  tag stig_id: 'AMZL-23-030741'
