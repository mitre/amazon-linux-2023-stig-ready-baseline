control 'AMZL-23-230468' do
  title 'Amazon Linux 2023 must enable auditing of processes that start prior to the audit
daemon.'
...
for which the system is capable of generating audit records.
    ...
    DoD has defined the list of events for which Amazon Linux 2023 will provide an audit
...
all direct access to the information system;
  ...
  desc 'check', 'Verify Amazon Linux 2023 enables auditing of processes that start prior to the audit
...
finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to audit processes that start prior to the audit daemon
...
configuration survives kernel updates:
  ...
  tag gid: 'AMZL-23-230468'
  tag rid: 'AMZL-23-230468r627750_rule'
  tag stig_id: 'AMZL-23-030601'
