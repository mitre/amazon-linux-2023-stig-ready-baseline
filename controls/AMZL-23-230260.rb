control 'AMZL-23-230260' do
  title 'Amazon Linux 2023 library files must have mode 0755 or less permissive.'
...
more permissive than 0755.
  ...
  tag gid: 'AMZL-23-230260'
  tag rid: 'AMZL-23-230260r627750_rule'
  tag stig_id: 'AMZL-23-010330'
