control 'AMZL-23-244519' do
  title 'Amazon Linux 2023 must display a banner before granting local or remote access to
...
with human users and are not required when such human interfaces do not exist.'
  desc 'check', 'Verify Amazon Linux 2023 displays a banner before granting access to the operating
...
"/etc/dconf/db/local.d/01-banner-message":
  ...
  tag gid: 'AMZL-23-244519'
  tag rid: 'AMZL-23-244519r743806_rule'
  tag stig_id: 'AMZL-23-010049'
