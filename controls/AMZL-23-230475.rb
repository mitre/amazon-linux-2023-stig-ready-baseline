control 'AMZL-23-230475' do
  title 'Amazon Linux 2023 must use cryptographic mechanisms to protect the integrity of
audit tools.'
...
integrity of the audit tools.
  ...
  tag gid: 'AMZL-23-230475'
  tag rid: 'AMZL-23-230475r627750_rule'
  tag stig_id: 'AMZL-23-030650'
