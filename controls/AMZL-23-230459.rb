control 'AMZL-23-230459' do
  title "Successful/unsuccessful uses of the fchown system call in Amazon Linux 2023 must
...
perm_mod
  ...
  tag gid: 'AMZL-23-230459'
  tag rid: 'AMZL-23-230459r627750_rule'
  tag stig_id: 'AMZL-23-030520'
