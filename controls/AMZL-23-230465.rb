control 'AMZL-23-230465' do
  title 'Successful/unsuccessful uses of the kmod command in Amazon Linux 2023 must
...
all direct access to the information system;
  ...
  desc 'check', 'Verify if Amazon Linux 2023 is configured to audit the execution of the module
...
is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to audit the execution of the module management program
...
-k modules
  ...
  tag gid: 'AMZL-23-230465'
  tag rid: 'AMZL-23-230465r627750_rule'
  tag stig_id: 'AMZL-23-030580'
