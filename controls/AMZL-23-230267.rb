control 'AMZL-23-230267' do
  title 'Amazon Linux 2023 must enable kernel parameters to enforce discretionary access
control on symlinks.'
...
command:
  ...
  tag gid: 'AMZL-23-230267'
  tag rid: 'AMZL-23-230267r627750_rule'
  tag stig_id: 'AMZL-23-010373'
