...
Amazon Linux 2023 utilizes "pwquality" as a mechanism to enforce password complexity. This is set in both:
...
Add the following line to the "/etc/pam.d/password-auth" file (or modify the line to have the required value):
  ...
  tag gid: 'AMZL-23-230356'
  tag rid: 'AMZL-23-230356r902728_rule'
  tag stig_id: 'AMZL-23-020100'
