control 'AMZL-23-230440' do
  title "Successful/unsuccessful uses of the renameat command in Amazon Linux 2023 must
...
delete
  ...
  tag gid: 'AMZL-23-230440'
  tag rid: 'AMZL-23-230440r627750_rule'
  tag stig_id: 'AMZL-23-030362'
