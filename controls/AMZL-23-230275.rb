control 'AMZL-23-230275' do
  title 'Amazon Linux 2023 must accept Personal Identity Verification (PIV) credentials.'
...
primary component of layered protection for national security systems.'
  desc 'check', 'Verify Amazon Linux 2023 accepts PIV credentials.
...
list does not include "PIV-II", this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to accept PIV credentials.
...
$ sudo yum install opensc'
  ...
  tag gid: 'AMZL-23-230275'
  tag rid: 'AMZL-23-230275r627750_rule'
  tag stig_id: 'AMZL-23-010410'
