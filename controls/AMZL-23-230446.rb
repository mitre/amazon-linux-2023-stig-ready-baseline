control 'AMZL-23-230446' do
  title 'Successful/unsuccessful uses of the delete_module command in Amazon Linux 2023
...
module_chng
  ...
  tag gid: 'AMZL-23-230446'
  tag rid: 'AMZL-23-230446r627750_rule'
  tag stig_id: 'AMZL-23-030390'
