control 'AMZL-23-230370' do
  title 'Amazon Linux 2023 passwords for new users must have a minimum of 15 characters.'
...
password.
  ...
  desc 'check', 'Verify that Amazon Linux 2023 enforces a minimum 15-character password length for new
...
length for new user accounts.
  ...
  tag gid: 'AMZL-23-230370'
  tag rid: 'AMZL-23-230370r627750_rule'
  tag stig_id: 'AMZL-23-020231'
