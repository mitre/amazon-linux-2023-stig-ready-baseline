control 'AMZL-23-230274' do
  title 'Amazon Linux 2023 must implement certificate status checking for multifactor
authentication.'
...
U.S. Government Personal Identity Verification (PIV) card and the DoD CAC.
    ...
    Amazon Linux 2023 includes multiple options for configuring certificate status
...
$ sudo systemctl restart sssd.service'
  ...
  tag gid: 'AMZL-23-230274'
  tag rid: 'AMZL-23-230274r858741_rule'
  tag stig_id: 'AMZL-23-010400'
