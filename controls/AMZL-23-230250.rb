control 'AMZL-23-230250' do
  title 'The Amazon Linux 2023 /var/log directory must be group-owned by root.'
...
following command:
  ...
  tag gid: 'AMZL-23-230250'
  tag rid: 'AMZL-23-230250r627750_rule'
  tag stig_id: 'AMZL-23-010260'
