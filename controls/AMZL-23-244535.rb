control 'AMZL-23-244535' do
  title 'Amazon Linux 2023 must initiate a session lock for graphical user interfaces when
...
file should be created under the appropriate subdirectory.
  ...
  tag gid: 'AMZL-23-244535'
  tag rid: 'AMZL-23-244535r743854_rule'
  tag stig_id: 'AMZL-23-020031'
