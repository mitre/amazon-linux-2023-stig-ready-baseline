control 'AMZL-23-230535' do
  title 'Amazon Linux 2023 must prevent IPv6 Internet Control Message Protocol (ICMP)
...
could result in a man-in-the-middle attack."
  desc 'check', 'Verify Amazon Linux 2023 will not accept IPv6 ICMP redirect messages.
...
returned, or the line is commented out, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to prevent IPv6 ICMP redirect messages from being accepted
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230535'
  tag rid: 'AMZL-23-230535r744035_rule'
  tag stig_id: 'AMZL-23-040210'
