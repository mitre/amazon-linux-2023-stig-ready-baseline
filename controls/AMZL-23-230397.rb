control 'AMZL-23-230397' do
  title 'Amazon Linux 2023 audit logs must be owned by root to prevent unauthorized read
access.'
...
location is "/var/log/audit/audit.log".'
  ...
  tag gid: 'AMZL-23-230397'
  tag rid: 'AMZL-23-230397r627750_rule'
  tag stig_id: 'AMZL-23-030080'
