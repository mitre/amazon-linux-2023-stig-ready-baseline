control 'AMZL-23-230450' do
  title "Successful/unsuccessful uses of the openat system call in Amazon Linux 2023 must
...
auid!=unset -k perm_access
  ...
  tag gid: 'AMZL-23-230450'
  tag rid: 'AMZL-23-230450r627750_rule'
  tag stig_id: 'AMZL-23-030430'
