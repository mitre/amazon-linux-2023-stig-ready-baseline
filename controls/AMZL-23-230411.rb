control 'AMZL-23-230411' do
  title 'The Amazon Linux 2023 audit package must be installed.'
...
with the following command:
  ...
  tag gid: 'AMZL-23-230411'
  tag rid: 'AMZL-23-230411r744000_rule'
  tag stig_id: 'AMZL-23-030180'
