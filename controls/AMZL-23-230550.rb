control 'AMZL-23-230550' do
  title 'Amazon Linux 2023 must be configured to prevent unrestricted mail relaying.'
...
restrict client connections to the local network with the following command:
  ...
  tag gid: 'AMZL-23-230550'
  tag rid: 'AMZL-23-230550r627750_rule'
  tag stig_id: 'AMZL-23-040290'
