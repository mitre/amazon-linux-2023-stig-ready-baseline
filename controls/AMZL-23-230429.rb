control 'AMZL-23-230429' do
  title 'Successful/unsuccessful uses of semanage in Amazon Linux 2023 must generate an
audit record.'
...
auid!=unset -k privileged-unix-update
  ...
  tag gid: 'AMZL-23-230429'
  tag rid: 'AMZL-23-230429r627750_rule'
  tag stig_id: 'AMZL-23-030313'
