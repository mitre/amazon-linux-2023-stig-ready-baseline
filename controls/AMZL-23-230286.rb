control 'AMZL-23-230286' do
  title 'The Amazon Linux 2023 SSH public host key files must have mode 0644 or less
permissive.'
...
the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-230286'
  tag rid: 'AMZL-23-230286r627750_rule'
  tag stig_id: 'AMZL-23-010480'
