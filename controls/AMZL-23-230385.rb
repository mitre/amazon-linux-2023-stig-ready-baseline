control 'AMZL-23-230385' do
  title 'Amazon Linux 2023 must define default permissions for logon and non-logon shells.'
...
and "etc/csh.cshrc" files to "077":
  ...
  tag gid: 'AMZL-23-230385'
  tag rid: 'AMZL-23-230385r627750_rule'
  tag stig_id: 'AMZL-23-020353'
