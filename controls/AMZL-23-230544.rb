control 'AMZL-23-230544' do
  title 'Amazon Linux 2023 must ignore IPv6 Internet Control Message Protocol (ICMP)
redirect messages.'
...
could result in a man-in-the-middle attack."
  desc 'check', 'Verify Amazon Linux 2023 ignores IPv6 ICMP redirect messages.
...
returned, or the line is commented out, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to ignore IPv6 ICMP redirect messages with the following
command:
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230544'
  tag rid: 'AMZL-23-230544r744050_rule'
  tag stig_id: 'AMZL-23-040280'
