control 'AMZL-23-230532' do
  title 'The debug-shell systemd service must be disabled on Amazon Linux 2023.'
...
access when the system is rebooted.'
  desc 'check', 'Verify Amazon Linux 2023 is configured to mask the debug-shell systemd service with
...
following command:
  ...
  tag gid: 'AMZL-23-230532'
  tag rid: 'AMZL-23-230532r627750_rule'
  tag stig_id: 'AMZL-23-040180'
