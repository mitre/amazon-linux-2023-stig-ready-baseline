control 'AMZL-23-230483' do
  title 'Amazon Linux 2023 must take action when allocated audit record storage volume
...
storage capacity expansion.'
  desc 'check', 'Verify Amazon Linux 2023 takes action when allocated audit record storage volume
...
adding/modifying the following line in the /etc/audit/auditd.conf file.
  ...
  tag gid: 'AMZL-23-230483'
  tag rid: 'AMZL-23-230483r744014_rule'
  tag stig_id: 'AMZL-23-030730'
