control 'AMZL-23-230372' do
  title 'Amazon Linux 2023 must implement smart card logon for multifactor authentication
...
Amazon Linux 2023. Some methods include a local system multifactor account mapping or
...
client operating system handle the multifactor authentication correctly.'
  desc 'check', 'Verify Amazon Linux 2023 uses multifactor authentication for local access to accounts.
...
this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to use multifactor authentication for local access to
accounts.
...
restart the "sssd" service, run the following command:
  ...
  tag gid: 'AMZL-23-230372'
  tag rid: 'AMZL-23-230372r627750_rule'
  tag stig_id: 'AMZL-23-020250'
