control 'AMZL-23-230235' do
  title 'Amazon Linux 2023 operating systems booted with a BIOS must require
...
the following command:
  ...
  tag gid: 'AMZL-23-230235'
  tag rid: 'AMZL-23-230235r743925_rule'
  tag stig_id: 'AMZL-23-010150'
