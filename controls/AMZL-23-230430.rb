control 'AMZL-23-230430' do
  title 'Successful/unsuccessful uses of setfiles in Amazon Linux 2023 must generate an
audit record.'
...
auid!=unset -k privileged-unix-update
  ...
  tag gid: 'AMZL-23-230430'
  tag rid: 'AMZL-23-230430r627750_rule'
  tag stig_id: 'AMZL-23-030314'
