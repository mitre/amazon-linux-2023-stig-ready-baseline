control 'AMZL-23-244527' do
  title 'Amazon Linux 2023 must have the packages required to use the hardware random
...
several security functions (i.e., ciphers).'
  desc 'check', 'Check that Amazon Linux 2023 has the packages required to enabled the hardware random
...
generator entropy gatherer service with the following command:
  ...
  tag gid: 'AMZL-23-244527'
  tag rid: 'AMZL-23-244527r743830_rule'
  tag stig_id: 'AMZL-23-010472'
