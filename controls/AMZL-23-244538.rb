control 'AMZL-23-244538' do
  title 'Amazon Linux 2023 must prevent a user from overriding the session idle-delay
...
file should be created under the appropriate subdirectory.
  ...
  tag gid: 'AMZL-23-244538'
  tag rid: 'AMZL-23-244538r743863_rule'
  tag stig_id: 'AMZL-23-020081'
