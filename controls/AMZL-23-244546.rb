control 'AMZL-23-244546' do
  title 'The Amazon Linux 2023 fapolicy module must be configured to employ a deny-all,
...
an SA through shared resources.
    ...
    Amazon Linux 2023 ships with many optional packages. One such package is a file access
...
not namespace aware and can cause issues when launching or running containers.'
  desc 'check', 'Verify the Amazon Linux 2023 "fapolicyd" employs a deny-all, permit-by-exception
policy.
...
deny-all, permit-by-exception policy, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to employ a deny-all, permit-by-exception application
...
/etc/fapolicyd/fapolicyd.conf file.
  ...
  tag gid: 'AMZL-23-244546'
  tag rid: 'AMZL-23-244546r743887_rule'
  tag stig_id: 'AMZL-23-040137'
