control 'AMZL-23-230443' do
  title "Successful/unsuccessful uses of the unlinkat command in Amazon Linux 2023 must
...
delete
  ...
  tag gid: 'AMZL-23-230443'
  tag rid: 'AMZL-23-230443r627750_rule'
  tag stig_id: 'AMZL-23-030365'
