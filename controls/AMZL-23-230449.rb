control 'AMZL-23-230449' do
  title 'Successful/unsuccessful uses of the truncate command in Amazon Linux 2023 must
...
auid!=unset -k perm_access
  ...
  tag gid: 'AMZL-23-230449'
  tag rid: 'AMZL-23-230449r627750_rule'
  tag stig_id: 'AMZL-23-030420'
