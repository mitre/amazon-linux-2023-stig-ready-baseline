control 'AMZL-23-230380' do
  title 'Amazon Linux 2023 must not allow accounts configured with blank or null
passwords.'
...
the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-230380'
  tag rid: 'AMZL-23-230380r743993_rule'
  tag stig_id: 'AMZL-23-020330'
