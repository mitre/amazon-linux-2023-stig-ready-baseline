control 'AMZL-23-237643' do
  title 'Amazon Linux 2023 must require re-authentication when using the "sudo" command.'
...
"0".'
  ...
  tag gid: 'AMZL-23-237643'
  tag rid: 'AMZL-23-237643r646899_rule'
  tag stig_id: 'AMZL-23-010384'
