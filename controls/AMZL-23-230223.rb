...
Amazon Linux 2023 utilizes GRUB 2 as the default bootloader. Note that GRUB 2 command-line parameters are defined in the "kernelopts" variable of the /boot/grub2/grubenv file for all kernel boot entries. The command "fips-mode-setup" modifies the "kernelopts" variable, which in turn updates all kernel boot entries. 
...
Reboot the system for the changes to take effect.'
  ...
  tag gid: 'AMZL-23-230223'
  tag rid: 'AMZL-23-230223r928585_rule'
  tag stig_id: 'AMZL-23-010020'
