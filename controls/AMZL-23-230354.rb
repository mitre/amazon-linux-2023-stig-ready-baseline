control 'AMZL-23-230354' do
  title 'Amazon Linux 2023 must prevent a user from overriding the session lock-delay
...
file should be created under the appropriate subdirectory.
  ...
  tag gid: 'AMZL-23-230354'
  tag rid: 'AMZL-23-230354r743990_rule'
  tag stig_id: 'AMZL-23-020080'
