control 'AMZL-23-230318' do
  title 'All Amazon Linux 2023 world-writable directories must be owned by root, sys, bin,
...
group.'
  ...
  tag gid: 'AMZL-23-230318'
  tag rid: 'AMZL-23-230318r743960_rule'
  tag stig_id: 'AMZL-23-010700'
