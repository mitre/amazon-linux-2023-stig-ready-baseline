control 'AMZL-23-230413' do
  title 'The Amazon Linux 2023 audit system must be configured to audit any usage of the
...
"unset" in the same way.'
  desc 'check', 'Verify if Amazon Linux 2023 is configured to audit the execution of the
...
this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to audit the execution of the "lremovexattr" system
...
perm_mod
  ...
  tag gid: 'AMZL-23-230413'
  tag rid: 'AMZL-23-230413r627750_rule'
  tag stig_id: 'AMZL-23-030200'
