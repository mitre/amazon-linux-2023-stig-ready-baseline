control 'AMZL-23-244532' do
  title 'Amazon Linux 2023 must be configured so that all files and directories contained
...
"/home/smithj" and is a member of the users group.
  ...
  tag gid: 'AMZL-23-244532'
  tag rid: 'AMZL-23-244532r743845_rule'
  tag stig_id: 'AMZL-23-010741'
