control 'AMZL-23-230350' do
  title 'Amazon Linux 2023 must prevent users from disabling session control mechanisms.'
...
to remove any instances of tmux.'
  ...
  tag gid: 'AMZL-23-230350'
  tag rid: 'AMZL-23-230350r627750_rule'
  tag stig_id: 'AMZL-23-020042'
