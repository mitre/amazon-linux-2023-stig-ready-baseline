control 'AMZL-23-230527' do
  title 'Amazon Linux 2023 must force a frequent session key renegotiation for SSH
...
"/etc/ssh/sshd_config" file:
  ...
  tag gid: 'AMZL-23-230527'
  tag rid: 'AMZL-23-230527r627750_rule'
  tag stig_id: 'AMZL-23-040161'
