control 'AMZL-23-230361' do
  title 'Amazon Linux 2023 must require the maximum number of repeating characters be
...
the line to have the required value):
  ...
  tag gid: 'AMZL-23-230361'
  tag rid: 'AMZL-23-230361r627750_rule'
  tag stig_id: 'AMZL-23-020150'
