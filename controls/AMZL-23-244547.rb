control 'AMZL-23-244547' do
  title 'Amazon Linux 2023 must have the USBGuard installed.'
...
$ sudo yum install usbguard.x86_64'
  ...
  tag gid: 'AMZL-23-244547'
  tag rid: 'AMZL-23-244547r743890_rule'
  tag stig_id: 'AMZL-23-040139'
