control 'AMZL-23-230455' do
  title 'Successful/unsuccessful uses of the chown command in Amazon Linux 2023 must
...
following line to "/etc/audit/rules.d/audit.rules":
  ...
  tag gid: 'AMZL-23-230455'
  tag rid: 'AMZL-23-230455r627750_rule'
  tag stig_id: 'AMZL-23-030480'
