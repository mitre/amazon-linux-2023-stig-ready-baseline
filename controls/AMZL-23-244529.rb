control 'AMZL-23-244529' do
  title 'Amazon Linux 2023 must use a separate file system for /var/tmp.'
...
the following command:
  ...
  tag gid: 'AMZL-23-244529'
  tag rid: 'AMZL-23-244529r743836_rule'
  tag stig_id: 'AMZL-23-010544'
