...
audit processing failure.
    ...
    Check that Amazon Linux 2023 notifies the SA and ISSO (at a minimum) in the event of
...
administrators are notified via email for those situations:
  ...
  tag gid: 'AMZL-23-230388'
  tag rid: 'AMZL-23-230388r627750_rule'
  tag stig_id: 'AMZL-23-030020'
