control 'AMZL-23-230301' do
  title 'Amazon Linux 2023 must prevent special devices on non-root local partitions.'
...
non-root local partitions.'
  ...
  tag gid: 'AMZL-23-230301'
  tag rid: 'AMZL-23-230301r627750_rule'
  tag stig_id: 'AMZL-23-010580'
