control 'AMZL-23-230540' do
  title 'Amazon Linux 2023 must not be performing packet forwarding unless the system is a
router.'
...
across the network.'
  desc 'check', 'Verify Amazon Linux 2023 is not performing packet forwarding, unless the system is a
router.
...
is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to not allow packet forwarding, unless the system is a
...
lines in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230540'
  tag rid: 'AMZL-23-230540r627750_rule'
  tag stig_id: 'AMZL-23-040260'
