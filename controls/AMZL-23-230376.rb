control 'AMZL-23-230376' do
  title 'Amazon Linux 2023 must prohibit the use of cached authentications after one day.'
...
the authentication information may be questionable.
    ...
    Amazon Linux 2023 includes multiple options for configuring authentication, but this
...
line "[pam]".
  ...
  tag gid: 'AMZL-23-230376'
  tag rid: 'AMZL-23-230376r627750_rule'
  tag stig_id: 'AMZL-23-020290'
