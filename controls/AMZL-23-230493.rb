control 'AMZL-23-230493' do
  title 'Amazon Linux 2023 must cover or disable the built-in or attached camera when not
in use.'
...
the following example:
  ...
  tag gid: 'AMZL-23-230493'
  tag rid: 'AMZL-23-230493r627750_rule'
  tag stig_id: 'AMZL-23-040020'
