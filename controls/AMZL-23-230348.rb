control 'AMZL-23-230348' do
  title 'Amazon Linux 2023 must enable a user session lock until that user re-establishes
...
line:
  ...
  tag gid: 'AMZL-23-230348'
  tag rid: 'AMZL-23-230348r743987_rule'
  tag stig_id: 'AMZL-23-020040'
