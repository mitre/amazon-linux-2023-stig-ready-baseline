control 'AMZL-23-230349' do
  title 'Amazon Linux 2023 must ensure session control is automatically started at shell
initialization.'
...
"/etc/bashrc" configuration file:
  ...
  tag gid: 'AMZL-23-230349'
  tag rid: 'AMZL-23-230349r627750_rule'
  tag stig_id: 'AMZL-23-020041'
