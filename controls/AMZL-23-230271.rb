control 'AMZL-23-230271' do
  title 'Amazon Linux 2023 must require users to provide a password for privilege
escalation.'
...
file or files in the "/etc/sudoers.d" directory.'
  ...
  tag gid: 'AMZL-23-230271'
  tag rid: 'AMZL-23-230271r627750_rule'
  tag stig_id: 'AMZL-23-010380'
