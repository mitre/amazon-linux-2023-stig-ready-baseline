control 'AMZL-23-230270' do
  title 'Amazon Linux 2023 must prevent kernel profiling by unprivileged users.'
...
command:
  ...
  tag gid: 'AMZL-23-230270'
  tag rid: 'AMZL-23-230270r627750_rule'
  tag stig_id: 'AMZL-23-010376'
