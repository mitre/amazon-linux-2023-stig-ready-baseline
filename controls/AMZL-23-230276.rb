control 'AMZL-23-230276' do
  title 'Amazon Linux 2023 must implement non-executable data to protect its memory from
...
BIOS.'
  ...
  tag gid: 'AMZL-23-230276'
  tag rid: 'AMZL-23-230276r627750_rule'
  tag stig_id: 'AMZL-23-010420'
