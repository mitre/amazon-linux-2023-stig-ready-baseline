control 'AMZL-23-230518' do
  title 'Amazon Linux 2023 must mount /var/log/audit with the nosuid option.'
...
defaults,nodev,nosuid,noexec 0 0'
  ...
  tag gid: 'AMZL-23-230518'
  tag rid: 'AMZL-23-230518r627750_rule'
  tag stig_id: 'AMZL-23-040130'
