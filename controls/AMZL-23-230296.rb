control 'AMZL-23-230296' do
  title 'Amazon Linux 2023 must not permit direct logons to the root account using remote
access via SSH.'
...
commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to stop users from logging on remotely as the "root"
user via SSH.
...
the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-230296'
  tag rid: 'AMZL-23-230296r627750_rule'
  tag stig_id: 'AMZL-23-010550'
