control 'AMZL-23-230306' do
  title 'Amazon Linux 2023 must prevent code from being executed on file systems that are
...
file systems that are being imported via NFS.'
  ...
  tag gid: 'AMZL-23-230306'
  tag rid: 'AMZL-23-230306r627750_rule'
  tag stig_id: 'AMZL-23-010630'
