control 'AMZL-23-230295' do
  title 'A separate Amazon Linux 2023 filesystem must be used for the /tmp directory.'
...
system/partition.'
  ...
  tag gid: 'AMZL-23-230295'
  tag rid: 'AMZL-23-230295r627750_rule'
  tag stig_id: 'AMZL-23-010543'
