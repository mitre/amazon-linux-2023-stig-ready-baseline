control 'AMZL-23-230360' do
  title 'Amazon Linux 2023 must require the maximum number of repeating characters of the
...
the line to have the required value):
  ...
  tag gid: 'AMZL-23-230360'
  tag rid: 'AMZL-23-230360r627750_rule'
  tag stig_id: 'AMZL-23-020140'
