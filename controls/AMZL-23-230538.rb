control 'AMZL-23-230538' do
  title 'Amazon Linux 2023 must not forward IPv6 source-routed packets.'
...
forwarding is enabled and the system is functioning as a router.'
  desc 'check', 'Verify Amazon Linux 2023 does not accept IPv6 source-routed packets.
...
returned, or the line is commented out, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to not forward IPv6 source-routed packets with the
following command:
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-230538'
  tag rid: 'AMZL-23-230538r744042_rule'
  tag stig_id: 'AMZL-23-040240'
