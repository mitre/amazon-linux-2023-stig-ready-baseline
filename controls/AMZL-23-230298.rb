control 'AMZL-23-230298' do
  title 'The rsyslog service must be running in Amazon Linux 2023.'
  desc 'Configuring Amazon Linux 2023 to implement organization-wide security
...
commands:
  ...
  tag gid: 'AMZL-23-230298'
  tag rid: 'AMZL-23-230298r627750_rule'
  tag stig_id: 'AMZL-23-010561'
