control 'AMZL-23-230292' do
  title 'Amazon Linux 2023 must use a separate file system for /var.'
...
following command:
  ...
  tag gid: 'AMZL-23-230292'
  tag rid: 'AMZL-23-230292r627750_rule'
  tag stig_id: 'AMZL-23-010540'
