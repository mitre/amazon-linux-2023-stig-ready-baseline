control 'AMZL-23-230457' do
  title "Successful/unsuccessful uses of the lchown system call in Amazon Linux 2023 must
...
\"unset\" in the same way.
  ...
  desc  'rationale', ''
  desc  'check', "
    Verify Amazon Linux 2023 generates an audit record when successful/unsuccessful
...
perm_mod
  ...
  tag gid: 'AMZL-23-230457'
  tag rid: 'AMZL-23-230457r627750_rule'
  tag stig_id: 'AMZL-23-030500'
