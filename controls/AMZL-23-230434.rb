control 'AMZL-23-230434' do
  title 'Successful/unsuccessful uses of the ssh-keysign in Amazon Linux 2023 must
...
auid>=1000 -F auid!=unset -k privileged-ssh
  ...
  tag gid: 'AMZL-23-230434'
  tag rid: 'AMZL-23-230434r744002_rule'
  tag stig_id: 'AMZL-23-030320'
