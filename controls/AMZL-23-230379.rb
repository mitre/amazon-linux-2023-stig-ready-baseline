control 'AMZL-23-230379' do
  title 'Amazon Linux 2023 must not have unnecessary accounts.'
...
allow for a normal user to perform administrative-level actions.
  ...
  tag gid: 'AMZL-23-230379'
  tag rid: 'AMZL-23-230379r627750_rule'
  tag stig_id: 'AMZL-23-020320'
