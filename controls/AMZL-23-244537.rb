control 'AMZL-23-244537' do
  title 'Amazon Linux 2023 must have the tmux package installed.'
...
as the recommended session controlling package.'
  desc 'check', 'Verify Amazon Linux 2023 has the "tmux" package installed, by running the following
command:
...
the following command:
  ...
  tag gid: 'AMZL-23-244537'
  tag rid: 'AMZL-23-244537r743860_rule'
  tag stig_id: 'AMZL-23-020039'
