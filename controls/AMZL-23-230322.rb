control 'AMZL-23-230322' do
  title 'All Amazon Linux 2023 local interactive user home directories must be group-owned
...
of "/home/smithj", and has a primary group of users.
  ...
  tag gid: 'AMZL-23-230322'
  tag rid: 'AMZL-23-230322r743963_rule'
  tag stig_id: 'AMZL-23-010740'
