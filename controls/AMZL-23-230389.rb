control 'AMZL-23-230389' do
  title 'The Amazon Linux 2023 Information System Security Officer (ISSO) and System
...
notified of an audit processing failure, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to notify administrators in the event of an audit
processing failure.
  ...
  tag gid: 'AMZL-23-230389'
  tag rid: 'AMZL-23-230389r627750_rule'
  tag stig_id: 'AMZL-23-030030'
