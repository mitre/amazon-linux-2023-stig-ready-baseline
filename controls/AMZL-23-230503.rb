control 'AMZL-23-230503' do
  title 'Amazon Linux 2023 must be configured to disable USB mass storage.'
...
storage devices.
  ...
  tag gid: 'AMZL-23-230503'
  tag rid: 'AMZL-23-230503r627750_rule'
  tag stig_id: 'AMZL-23-040080'
