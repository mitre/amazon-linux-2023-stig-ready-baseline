control 'AMZL-23-230513' do
  title 'Amazon Linux 2023 must mount /tmp with the noexec option.'
...
adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230513'
  tag rid: 'AMZL-23-230513r627750_rule'
  tag stig_id: 'AMZL-23-040125'
