control 'AMZL-23-230331' do
  title 'Amazon Linux 2023 temporary user accounts must be provisioned with an expiration
...
immediacy in account activation.
    ...
    If temporary accounts are used, Amazon Linux 2023 must be configured to automatically
terminate these types of accounts after a DoD-defined time period of 72 hours.

    To address access requirements, many Amazon Linux 2023 operating systems may be
...
be created.
  ...
  tag gid: 'AMZL-23-230331'
  tag rid: 'AMZL-23-230331r627750_rule'
  tag stig_id: 'AMZL-23-020000'
