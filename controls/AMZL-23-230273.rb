control 'AMZL-23-230273' do
  title 'Amazon Linux 2023 must have the packages required for multifactor authentication
installed.'
...
installing the required package with the following command:
  ...
  tag gid: 'AMZL-23-230273'
  tag rid: 'AMZL-23-230273r743943_rule'
  tag stig_id: 'AMZL-23-010390'
