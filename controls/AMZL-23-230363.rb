control 'AMZL-23-230363' do
  title 'Amazon Linux 2023 must require the change of at least 8 characters when passwords
are changed.'
...
line to have the required value):
  ...
  tag gid: 'AMZL-23-230363'
  tag rid: 'AMZL-23-230363r627750_rule'
  tag stig_id: 'AMZL-23-020170'
