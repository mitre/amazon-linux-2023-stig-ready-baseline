control 'AMZL-23-244525' do
  title 'The Amazon Linux 2023 SSH daemon must be configured with a timeout interval.'
...
and releases the resources associated with that session.
    ...
    Amazon Linux 2023 utilizes /etc/ssh/sshd_config for configurations of OpenSSH. Within
...
or less in "/etc/ssh/sshd_config", or is commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to automatically terminate all network connections
...
inactivity.
  ...
  tag gid: 'AMZL-23-244525'
  tag rid: 'AMZL-23-244525r743824_rule'
  tag stig_id: 'AMZL-23-010201'
