control 'AMZL-23-230511' do
  title 'Amazon Linux 2023 must mount /tmp with the nodev option.'
...
adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230511'
  tag rid: 'AMZL-23-230511r627750_rule'
  tag stig_id: 'AMZL-23-040123'
