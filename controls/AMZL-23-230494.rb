control 'AMZL-23-230494' do
  title 'Amazon Linux 2023 must disable the asynchronous transfer mode (ATM) protocol.'
...
Reboot the system for the settings to take effect.'
  ...
  tag gid: 'AMZL-23-230494'
  tag rid: 'AMZL-23-230494r792911_rule'
  tag stig_id: 'AMZL-23-040021'
