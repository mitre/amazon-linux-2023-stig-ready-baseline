control 'AMZL-23-230346' do
  title 'Amazon Linux 2023 must limit the number of concurrent sessions to ten for all
...
".conf" file defined in /etc/security/limits.d/:
  ...
  tag gid: 'AMZL-23-230346'
  tag rid: 'AMZL-23-230346r627750_rule'
  tag stig_id: 'AMZL-23-020024'
