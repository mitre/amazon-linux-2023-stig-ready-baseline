...
Agreement for details."'
  desc 'check', %q(Verify Amazon Linux 2023 displays the Standard Mandatory DoD Notice and Consent Banner
before granting access to the operating system via a graphical user logon.

    Note: This requirement assumes the use of the Amazon Linux 2023 default graphical user
...
graphical interface.
  ...
  tag gid: 'AMZL-23-230226'
  tag rid: 'AMZL-23-230226r743916_rule'
  tag stig_id: 'AMZL-23-010050'
