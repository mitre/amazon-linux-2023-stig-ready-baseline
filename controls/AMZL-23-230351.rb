control 'AMZL-23-230351' do
  title 'Amazon Linux 2023 must be able to initiate directly a session lock for all
...
This requirement assumes the use of the Amazon Linux 2023 default graphical user interface, Gnome Shell. If the system does not have any graphical user interface installed, this requirement is Not Applicable.
...
section of the database file and add or update the following lines:
  ...
  tag gid: 'AMZL-23-230351'
  tag rid: 'AMZL-23-230351r792899_rule'
  tag stig_id: 'AMZL-23-020050'
