control 'AMZL-23-230241' do
  title 'Amazon Linux 2023 must have policycoreutils package installed.'
...
installed with the following command:
  ...
  tag gid: 'AMZL-23-230241'
  tag rid: 'AMZL-23-230241r627750_rule'
  tag stig_id: 'AMZL-23-010171'
