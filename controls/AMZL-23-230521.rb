control 'AMZL-23-230521' do
  title 'Amazon Linux 2023 must mount /var/tmp with the nosuid option.'
...
by adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230521'
  tag rid: 'AMZL-23-230521r627750_rule'
  tag stig_id: 'AMZL-23-040133'
