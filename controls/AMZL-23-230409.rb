control 'AMZL-23-230409' do
  title 'Amazon Linux 2023 must generate audit records for all account creations,
...
information system (e.g., module or policy filter).'
  desc 'check', 'Verify Amazon Linux 2023 generates audit records for all account creations,
modifications, disabling, and termination events that affect "/etc/sudoers".
...
is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to generate audit records for all account creations,
modifications, disabling, and termination events that affect "/etc/sudoers".
...
"/etc/audit/rules.d/audit.rules":
  ...
  tag gid: 'AMZL-23-230409'
  tag rid: 'AMZL-23-230409r627750_rule'
  tag stig_id: 'AMZL-23-030171'
