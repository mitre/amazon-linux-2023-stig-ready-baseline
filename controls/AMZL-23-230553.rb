control 'AMZL-23-230553' do
  title 'The graphical display manager must not be installed on Amazon Linux 2023 unless
approved.'
...
xorg-x11-server-utils xorg-x11-server-Xwayland
  ...
  tag gid: 'AMZL-23-230553'
  tag rid: 'AMZL-23-230553r646886_rule'
  tag stig_id: 'AMZL-23-040320'
