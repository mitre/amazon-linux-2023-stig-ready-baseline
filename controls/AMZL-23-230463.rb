control 'AMZL-23-230463' do
  title 'Successful/unsuccessful uses of the usermod command in Amazon Linux 2023 must
...
auid!=unset -k privileged-usermod
  ...
  tag gid: 'AMZL-23-230463'
  tag rid: 'AMZL-23-230463r627750_rule'
  tag stig_id: 'AMZL-23-030560'
