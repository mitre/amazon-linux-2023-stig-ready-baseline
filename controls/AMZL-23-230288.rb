control 'AMZL-23-230288' do
  title 'The Amazon Linux 2023 SSH daemon must perform strict mode checking of home
...
the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-230288'
  tag rid: 'AMZL-23-230288r627750_rule'
  tag stig_id: 'AMZL-23-010500'
