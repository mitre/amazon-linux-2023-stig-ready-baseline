control 'AMZL-23-230510' do
  title 'Amazon Linux 2023 must mount /dev/shm with the noexec option.'
...
by adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230510'
  tag rid: 'AMZL-23-230510r627750_rule'
  tag stig_id: 'AMZL-23-040122'
