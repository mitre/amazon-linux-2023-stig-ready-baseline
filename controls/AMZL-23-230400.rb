control 'AMZL-23-230400' do
  title 'Amazon Linux 2023 audit log directory must be group-owned by root to prevent
...
path, by default this location is usually "/var/log/audit".'
  ...
  tag gid: 'AMZL-23-230400'
  tag rid: 'AMZL-23-230400r627750_rule'
  tag stig_id: 'AMZL-23-030110'
