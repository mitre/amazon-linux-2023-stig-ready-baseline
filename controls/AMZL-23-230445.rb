control 'AMZL-23-230445' do
  title "Successful/unsuccessful uses of the finit_module command in Amazon Linux 2023
...
module_chng
  ...
  tag gid: 'AMZL-23-230445'
  tag rid: 'AMZL-23-230445r627750_rule'
  tag stig_id: 'AMZL-23-030380'
