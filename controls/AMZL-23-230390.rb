control 'AMZL-23-230390' do
  title 'The Amazon Linux 2023 System must take appropriate action when an audit
...
storage repositories combined), or both.'
  desc 'check', 'Verify Amazon Linux 2023 takes the appropriate action when an audit processing failure
occurs.

    Check that Amazon Linux 2023 takes the appropriate action when an audit processing
...
by setting the "disk_error_action" to "SYSLOG".'
  ...
  tag gid: 'AMZL-23-230390'
  tag rid: 'AMZL-23-230390r627750_rule'
  tag stig_id: 'AMZL-23-030040'
