control 'AMZL-23-230328' do
  title 'A separate Amazon Linux 2023 filesystem must be used for user home directories
...
system/partition.'
  ...
  tag gid: 'AMZL-23-230328'
  tag rid: 'AMZL-23-230328r627750_rule'
  tag stig_id: 'AMZL-23-010800'
