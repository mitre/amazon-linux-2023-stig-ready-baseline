control 'AMZL-23-230239' do
  title 'The krb5-workstation package must not be installed on Amazon Linux 2023.'
...
requirement or remove it from the system with the following command:
  ...
  tag gid: 'AMZL-23-230239'
  tag rid: 'AMZL-23-230239r646864_rule'
  tag stig_id: 'AMZL-23-010162'
