control 'AMZL-23-230419' do
  title 'Successful/unsuccessful uses of the chcon command in Amazon Linux 2023 must
...
auid!=unset -k perm_mod
  ...
  tag gid: 'AMZL-23-230419'
  tag rid: 'AMZL-23-230419r627750_rule'
  tag stig_id: 'AMZL-23-030260'
