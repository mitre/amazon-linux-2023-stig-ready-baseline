control 'AMZL-23-230401' do
  title 'Amazon Linux 2023 audit log directory must have a mode of 0700 or less permissive
...
settings, audit reports) needed to successfully audit Amazon Linux 2023 system activity.'
...
by default this location is "/var/log/audit".'
  ...
  tag gid: 'AMZL-23-230401'
  tag rid: 'AMZL-23-230401r627750_rule'
  tag stig_id: 'AMZL-23-030120'
