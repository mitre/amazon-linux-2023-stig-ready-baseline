control 'AMZL-23-230358' do
  title 'Amazon Linux 2023 must enforce password complexity by requiring that at least one
...
compromised.
    ...
    Amazon Linux 2023 utilizes pwquality as a mechanism to enforce password complexity.
...
to have the required value):
  ...
  tag gid: 'AMZL-23-230358'
  tag rid: 'AMZL-23-230358r627750_rule'
  tag stig_id: 'AMZL-23-020120'
