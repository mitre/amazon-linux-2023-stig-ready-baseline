control 'AMZL-23-230525' do
  title 'A firewall must be able to protect against or limit the effects of
Denial of Service (DoS) attacks by ensuring Amazon Linux 2023 can implement rate-limiting
...
or must operate at degraded capacity.
    ...
    This requirement addresses the configuration of Amazon Linux 2023 to mitigate the
...
attacks on impacted network interfaces.'
  ...
  tag gid: 'AMZL-23-230525'
  tag rid: 'AMZL-23-230525r744029_rule'
  tag stig_id: 'AMZL-23-040150'
