control 'AMZL-23-230447' do
  title 'Successful/unsuccessful uses of the crontab command in Amazon Linux 2023 must
...
auid!=unset -k privileged-crontab
  ...
  tag gid: 'AMZL-23-230447'
  tag rid: 'AMZL-23-230447r627750_rule'
  tag stig_id: 'AMZL-23-030400'
