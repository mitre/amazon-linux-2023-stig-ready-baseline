control 'AMZL-23-230265' do
  title 'Amazon Linux 2023 must prevent the installation of software, patches, service
...
"/etc/dnf/dnf.conf" file:
  ...
  tag gid: 'AMZL-23-230265'
  tag rid: 'AMZL-23-230265r627750_rule'
  tag stig_id: 'AMZL-23-010371'
