control 'AMZL-23-230323' do
  title 'All Amazon Linux 2023 local interactive user home directories defined in the
...
give them visibility to system files they normally would not be able to access.'
  desc 'check', %q(Verify the assigned home directory of all local interactive users on Amazon Linux 2023
...
assigned" in "/etc/passwd".
  ...
  tag gid: 'AMZL-23-230323'
  tag rid: 'AMZL-23-230323r627750_rule'
  tag stig_id: 'AMZL-23-010750'
