control 'AMZL-23-230254' do
  title 'The Amazon Linux 2023 operating system must implement DoD-approved encryption in
the OpenSSL package.'
...
maintaining the confidentiality of the secret key used to generate the hash.
    ...
    Amazon Linux 2023 incorporates system-wide crypto policies by default.  The employed
...
this is a finding.'
  desc 'fix', 'Configure the Amazon Linux 2023 OpenSSL library to use only ciphers employing FIPS
140-2-approved algorithms with the following command:
  ...
  tag gid: 'AMZL-23-230254'
  tag rid: 'AMZL-23-230254r627750_rule'
  tag stig_id: 'AMZL-23-010293'
