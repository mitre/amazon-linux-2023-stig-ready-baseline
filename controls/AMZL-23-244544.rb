control 'AMZL-23-244544' do
  title 'A firewall must be active on Amazon Linux 2023.'
...
command:
  ...
  tag gid: 'AMZL-23-244544'
  tag rid: 'AMZL-23-244544r743881_rule'
  tag stig_id: 'AMZL-23-040101'
