control 'AMZL-23-230412' do
  title 'Successful/unsuccessful uses of the su command in Amazon Linux 2023 must generate
an audit record.'
...
"unset" in the same way.'
  desc 'check', 'Verify Amazon Linux 2023 generates audit records when successful/unsuccessful attempts
...
is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to generate audit records when successful/unsuccessful
...
-k privileged-priv_change
  ...
  tag gid: 'AMZL-23-230412'
  tag rid: 'AMZL-23-230412r627750_rule'
  tag stig_id: 'AMZL-23-030190'
