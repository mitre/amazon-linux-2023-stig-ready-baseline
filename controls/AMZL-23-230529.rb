control 'AMZL-23-230529' do
  title 'The x86 Ctrl-Alt-Delete key sequence must be disabled on Amazon Linux 2023.'
...
command line with the following command:
  ...
  tag gid: 'AMZL-23-230529'
  tag rid: 'AMZL-23-230529r627750_rule'
  tag stig_id: 'AMZL-23-040170'
