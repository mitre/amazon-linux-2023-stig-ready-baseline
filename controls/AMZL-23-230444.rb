control 'AMZL-23-230444' do
  title 'Successful/unsuccessful uses of the gpasswd command in Amazon Linux 2023 must
...
auid!=unset -k privileged-gpasswd
  ...
  tag gid: 'AMZL-23-230444'
  tag rid: 'AMZL-23-230444r627750_rule'
  tag stig_id: 'AMZL-23-030370'
