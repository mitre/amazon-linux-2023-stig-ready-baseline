control 'AMZL-23-230387' do
  title 'Cron logging must be implemented in Amazon Linux 2023.'
...
/etc/rsyslog.d/ directory:
  ...
  tag gid: 'AMZL-23-230387'
  tag rid: 'AMZL-23-230387r743996_rule'
  tag stig_id: 'AMZL-23-030010'
