control 'AMZL-23-244524' do
  title 'The Amazon Linux 2023 pam_unix.so module must be configured in the system-auth
...
include the sha512 option for pam_unix.so:
  ...
  tag gid: 'AMZL-23-244524'
  tag rid: 'AMZL-23-244524r743821_rule'
  tag stig_id: 'AMZL-23-010159'
