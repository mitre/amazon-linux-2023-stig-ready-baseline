control 'AMZL-23-230287' do
  title 'The Amazon Linux 2023 SSH private host key files must have mode 0640 or less permissive.'
...
The SSH daemon must be restarted for the changes to take effect. To restart the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-230287'
  tag rid: 'AMZL-23-230287r880714_rule'
  tag stig_id: 'AMZL-23-010490'
