control 'AMZL-23-230230' do
  title 'Amazon Linux 2023, for certificate-based authentication, must enforce authorized
...
following command:
  ...
  tag gid: 'AMZL-23-230230'
  tag rid: 'AMZL-23-230230r627750_rule'
  tag stig_id: 'AMZL-23-010100'
