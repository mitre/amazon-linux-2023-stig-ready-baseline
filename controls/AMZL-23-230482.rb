control 'AMZL-23-230482' do
  title 'Amazon Linux 2023 must authenticate the remote logging server for off-loading
audit logs.'
...
"/etc/rsyslog.conf" or "/etc/rsyslog.d/[customfile].conf":
  ...
  tag gid: 'AMZL-23-230482'
  tag rid: 'AMZL-23-230482r627750_rule'
  tag stig_id: 'AMZL-23-030720'
