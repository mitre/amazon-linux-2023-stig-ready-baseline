control 'AMZL-23-230386' do
  title 'The Amazon Linux 2023 audit system must be configured to audit the execution of
...
from insider threats and the advanced persistent threat.'
  desc 'check', 'Verify Amazon Linux 2023 audits the execution of privileged functions.

    Check if Amazon Linux 2023 is configured to audit the execution of the "execve"
...
this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to audit the execution of the "execve" system call.
...
"/etc/audit/rules.d/audit.rules":
  ...
  tag gid: 'AMZL-23-230386'
  tag rid: 'AMZL-23-230386r627750_rule'
  tag stig_id: 'AMZL-23-030000'
