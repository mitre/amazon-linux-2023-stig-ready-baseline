control 'AMZL-23-230283' do
  title 'There must be no shosts.equiv files on the Amazon Linux 2023 operating system.'
...
or for the use of two-factor authentication.'
  desc 'check', 'Verify there are no "shosts.equiv" files on Amazon Linux 2023 with the following
command:
...
$ sudo rm /etc/ssh/shosts.equiv'
  ...
  tag gid: 'AMZL-23-230283'
  tag rid: 'AMZL-23-230283r627750_rule'
  tag stig_id: 'AMZL-23-010460'
