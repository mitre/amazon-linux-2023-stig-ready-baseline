control 'AMZL-23-230488' do
  title 'Amazon Linux 2023 must not have any automated bug reporting tools installed.'
...
command:
  ...
  tag gid: 'AMZL-23-230488'
  tag rid: 'AMZL-23-230488r627750_rule'
  tag stig_id: 'AMZL-23-040001'
