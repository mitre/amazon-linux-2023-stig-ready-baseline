control 'AMZL-23-230316' do
  title 'For Amazon Linux 2023 systems using Domain Name Servers (DNS) resolution, at
...
resolution.
    ...
    By default, "NetworkManager" on Amazon Linux 2023 dynamically updates the
...
"/etc/resolv.conf" file can be created as follows:
  ...
  tag gid: 'AMZL-23-230316'
  tag rid: 'AMZL-23-230316r627750_rule'
  tag stig_id: 'AMZL-23-010680'
