control 'AMZL-23-230428' do
  title 'Successful/unsuccessful uses of postqueue in Amazon Linux 2023 must generate an
audit record.'
...
auid!=unset -k privileged-unix-update
  ...
  tag gid: 'AMZL-23-230428'
  tag rid: 'AMZL-23-230428r627750_rule'
  tag stig_id: 'AMZL-23-030312'
