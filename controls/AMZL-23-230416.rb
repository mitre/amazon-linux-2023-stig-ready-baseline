...
\"unset\" in the same way.
  ...
  desc  'rationale', ''
  desc  'check', "
    Verify if Amazon Linux 2023 is configured to audit the execution of the \"fsetxattr\"
...
this is a finding.
  "
  desc 'fix', "
    Configure Amazon Linux 2023 to audit the execution of the \"fsetxattr\" system call,
...
perm_mod
  ...
  tag gid: 'AMZL-23-230416'
  tag rid: 'AMZL-23-230416r627750_rule'
  tag stig_id: 'AMZL-23-030230'
