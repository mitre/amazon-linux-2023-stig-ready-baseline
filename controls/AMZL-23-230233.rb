control 'AMZL-23-230233' do
  title 'The Amazon Linux 2023 shadow password suite must be configured to use a sufficient number of hashing rounds.'
...
If both "SHA_CRYPT_MIN_ROUNDS" and "SHA_CRYPT_MAX_ROUNDS" are set, and the highest value for either is below "5000", this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to encrypt all stored passwords with a strong cryptographic hash.
...
SHA_CRYPT_MIN_ROUNDS 5000'
  ...
  tag gid: 'AMZL-23-230233'
  tag rid: 'AMZL-23-230233r880705_rule'
  tag stig_id: 'AMZL-23-010130'
