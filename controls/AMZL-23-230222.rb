control 'AMZL-23-230222' do
  title 'Amazon Linux 2023 vendor packaged system security patches and updates must be
...
available from Red Hat within 30 days or sooner as local policy dictates.'
  ...
  tag gid: 'AMZL-23-230222'
  tag rid: 'AMZL-23-230222r627750_rule'
  tag stig_id: 'AMZL-23-010010'
