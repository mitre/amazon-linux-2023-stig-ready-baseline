control 'AMZL-23-230551' do
  title 'The Amazon Linux 2023 file integrity tool must be configured to verify extended
attributes.'
  desc 'Extended attributes in file systems are used to contain arbitrary data
and file metadata with security implications.

    Amazon Linux 2023 installation media come with a file integrity tool, Advanced
...
uncommented file and directory selection lists.'
  ...
  tag gid: 'AMZL-23-230551'
  tag rid: 'AMZL-23-230551r627750_rule'
  tag stig_id: 'AMZL-23-040300'
