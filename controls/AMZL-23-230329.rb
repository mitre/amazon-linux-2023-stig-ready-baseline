control 'AMZL-23-230329' do
  title 'Unattended or automatic logon via the Amazon Linux 2023 graphical user interface
must not be allowed.'
...
[daemon] section of the "/etc/gdm/custom.conf" file to "false":
  ...
  tag gid: 'AMZL-23-230329'
  tag rid: 'AMZL-23-230329r627750_rule'
  tag stig_id: 'AMZL-23-010820'
