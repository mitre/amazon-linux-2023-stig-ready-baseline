control 'AMZL-23-230312' do
  title 'Amazon Linux 2023 must disable acquiring, saving, and processing core dumps.'
...
systemd-coredump@.service instance to process the core dump.'
  desc 'check', 'Verify Amazon Linux 2023 is not configured to acquire, save, or process core dumps
...
following command:
  ...
  tag gid: 'AMZL-23-230312'
  tag rid: 'AMZL-23-230312r627750_rule'
  tag stig_id: 'AMZL-23-010672'
