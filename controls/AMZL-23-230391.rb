control 'AMZL-23-230391' do
  title "The Amazon Linux 2023 System Administrator (SA) and Information System Security
...
storage volume is full.
    ...
    Check which action Amazon Linux 2023 takes when the audit storage volume is full with
...
a finding.
  "
  desc 'fix', "
    Configure Amazon Linux 2023 to notify the System Administrator (SA) and Information
...
\"/etc/audit/auditd.conf\" file with the a value of \"syslog\" or \"keep_logs\":
  ...
  tag gid: 'AMZL-23-230391'
  tag rid: 'AMZL-23-230391r743998_rule'
  tag stig_id: 'AMZL-23-030050'
