control 'AMZL-23-230524' do
  title 'Amazon Linux 2023 must block unauthorized peripherals before establishing a
connection.'
...
external storage, and printers.
    ...
    A new feature that Amazon Linux 2023 provides is the USBGuard software framework. The
...
a keyboard or mouse'
  ...
  tag gid: 'AMZL-23-230524'
  tag rid: 'AMZL-23-230524r744026_rule'
  tag stig_id: 'AMZL-23-040140'
