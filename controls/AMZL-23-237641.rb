control 'AMZL-23-237641' do
  title 'Amazon Linux 2023 must restrict privilege elevation to authorized personnel.'
...
ALL     ALL=(ALL:ALL) ALL'
  ...
  tag gid: 'AMZL-23-237641'
  tag rid: 'AMZL-23-237641r646893_rule'
  tag stig_id: 'AMZL-23-010382'
