control 'AMZL-23-244541' do
  title 'Amazon Linux 2023 must not allow blank or null passwords in the password-auth
file.'
...
"authselect" program.'
  ...
  tag gid: 'AMZL-23-244541'
  tag rid: 'AMZL-23-244541r743872_rule'
  tag stig_id: 'AMZL-23-020332'
