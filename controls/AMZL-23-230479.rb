control 'AMZL-23-230479' do
  title 'The Amazon Linux 2023 audit records must be off-loaded onto a different system or
...
storage capacity.
    ...
    Amazon Linux 2023 installation media provides "rsyslogd".  "rsyslogd" is a system
...
the name or IP address of the log aggregation server.
  ...
  tag gid: 'AMZL-23-230479'
  tag rid: 'AMZL-23-230479r627750_rule'
  tag stig_id: 'AMZL-23-030690'
