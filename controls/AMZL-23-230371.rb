control 'AMZL-23-230371' do
  title 'Amazon Linux 2023 duplicate User IDs (UIDs) must not exist for interactive users.'
...
accounts) or for detailed accountability of individual activity.'
  desc 'check', %q(Verify that Amazon Linux 2023 contains no duplicate User IDs (UIDs) for interactive
users.
...
account that has a duplicate User ID (UID) with a unique UID.'
  ...
  tag gid: 'AMZL-23-230371'
  tag rid: 'AMZL-23-230371r627750_rule'
  tag stig_id: 'AMZL-23-020240'
