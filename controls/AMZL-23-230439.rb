control 'AMZL-23-230439' do
  title 'Successful/unsuccessful uses of the rename command in Amazon Linux 2023 must
...
following rules in the "/etc/audit/rules.d/audit.rules" file:
  ...
  tag gid: 'AMZL-23-230439'
  tag rid: 'AMZL-23-230439r627750_rule'
  tag stig_id: 'AMZL-23-030361'
