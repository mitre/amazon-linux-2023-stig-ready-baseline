control 'AMZL-23-230365' do
  title 'Amazon Linux 2023 passwords for new users or password changes must have a 24
...
the required value):
  ...
  tag gid: 'AMZL-23-230365'
  tag rid: 'AMZL-23-230365r627750_rule'
  tag stig_id: 'AMZL-23-020190'
