control 'AMZL-23-230369' do
  title 'Amazon Linux 2023 passwords must have a minimum of 15 characters.'
...
line to have the required value):
  ...
  tag gid: 'AMZL-23-230369'
  tag rid: 'AMZL-23-230369r627750_rule'
  tag stig_id: 'AMZL-23-020230'
