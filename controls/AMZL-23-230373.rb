control 'AMZL-23-230373' do
  title 'Amazon Linux 2023 account identifiers (individuals, groups, roles, and devices)
...
unauthorized access to their user account has been obtained.
    ...
    Amazon Linux 2023 needs to track periods of inactivity and disable application
...
commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to disable account identifiers after 35 days of inactivity
...
immediately after the password expires.'
  ...
  tag gid: 'AMZL-23-230373'
  tag rid: 'AMZL-23-230373r627750_rule'
  tag stig_id: 'AMZL-23-020260'
