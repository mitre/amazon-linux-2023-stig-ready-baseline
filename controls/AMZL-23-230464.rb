control 'AMZL-23-230464' do
  title 'Successful/unsuccessful uses of the chacl command in Amazon Linux 2023 must
...
auid!=unset -k perm_mod
  ...
  tag gid: 'AMZL-23-230464'
  tag rid: 'AMZL-23-230464r627750_rule'
  tag stig_id: 'AMZL-23-030570'
