...
or remove it from the system with the following command:
  ...
  tag gid: 'AMZL-23-230558'
  tag rid: 'AMZL-23-230558r627750_rule'
  tag stig_id: 'AMZL-23-040360'
