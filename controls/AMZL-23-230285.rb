control 'AMZL-23-230285' do
  title 'Amazon Linux 2023 must enable the hardware random number generator entropy
gatherer service.'
...
Check that  Amazon Linux 2023 has enabled the hardware random number generator entropy gatherer service.
...
If the service is not "enabled" and "active", this is a finding.'
  ...
  tag gid: 'AMZL-23-230285'
  tag rid: 'AMZL-23-230285r928587_rule'
  tag stig_id: 'AMZL-23-010471'
