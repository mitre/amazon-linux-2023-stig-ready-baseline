control 'AMZL-23-230491' do
  title 'Amazon Linux 2023 must enable mitigations against processor-based
vulnerabilities.'
...
address space layout randomization (KASLR).'
  desc 'check', 'Verify Amazon Linux 2023 enables kernel page-table isolation with the following
commands:
...
finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to enable kernel page-table isolation with the following
command:
...
configuration survives kernel updates:
  ...
  tag gid: 'AMZL-23-230491'
  tag rid: 'AMZL-23-230491r627750_rule'
  tag stig_id: 'AMZL-23-040004'
