control 'AMZL-23-230257' do
  title 'Amazon Linux 2023 system commands must have mode 0755 or less permissive.'
...
with a mode more permissive than "0755".
  ...
  tag gid: 'AMZL-23-230257'
  tag rid: 'AMZL-23-230257r627750_rule'
  tag stig_id: 'AMZL-23-010300'
