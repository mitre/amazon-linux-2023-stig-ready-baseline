control 'AMZL-23-230533' do
  title 'The Trivial File Transfer Protocol (TFTP) server package must not be
installed if not required for Amazon Linux 2023 operational support.'
...
$ sudo yum remove tftp-server'
  ...
  tag gid: 'AMZL-23-230533'
  tag rid: 'AMZL-23-230533r627750_rule'
  tag stig_id: 'AMZL-23-040190'
