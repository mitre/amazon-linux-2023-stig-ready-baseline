control 'AMZL-23-244528' do
  title 'The Amazon Linux 2023 SSH daemon must not allow GSSAPI authentication, except to
...
the SSH daemon, run the following command:
  ...
  tag gid: 'AMZL-23-244528'
  tag rid: 'AMZL-23-244528r743833_rule'
  tag stig_id: 'AMZL-23-010522'
