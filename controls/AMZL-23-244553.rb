control 'AMZL-23-244553' do
  title 'Amazon Linux 2023 must ignore IPv4 Internet Control Message Protocol (ICMP)
redirect messages.'
...
could result in a man-in-the-middle attack."
  desc 'check', 'Verify Amazon Linux 2023 ignores IPv4 ICMP redirect messages.
...
returned, or the line is commented out, this is a finding.'
  desc 'fix', %q(Configure Amazon Linux 2023 to ignore IPv4 ICMP redirect messages with the following
command:
...
line in the appropriate file under "/etc/sysctl.d":
  ...
  tag gid: 'AMZL-23-244553'
  tag rid: 'AMZL-23-244553r743908_rule'
  tag stig_id: 'AMZL-23-040279'
