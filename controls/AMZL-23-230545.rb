control 'AMZL-23-230545' do
  title 'Amazon Linux 2023 must disable access to network bpf syscall from unprivileged
processes.'
...
additional attack vectors.'
  desc 'check', 'Verify Amazon Linux 2023 prevents privilege escalation thru the kernel by disabling
...
returned, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to prevent privilege escalation thru the kernel by
...
effect. To reload the contents of the files, run the following command:
  ...
  tag gid: 'AMZL-23-230545'
  tag rid: 'AMZL-23-230545r627750_rule'
  tag stig_id: 'AMZL-23-040281'
