control 'AMZL-23-230514' do
  title 'Amazon Linux 2023 must mount /var/log with the nodev option.'
...
by adding /modifying the /etc/fstab with the following line:
  ...
  tag gid: 'AMZL-23-230514'
  tag rid: 'AMZL-23-230514r627750_rule'
  tag stig_id: 'AMZL-23-040126'
