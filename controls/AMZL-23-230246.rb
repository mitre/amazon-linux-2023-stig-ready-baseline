control 'AMZL-23-230246' do
  title 'The Amazon Linux 2023 /var/log/messages file must be owned by root.'
...
following command:
  ...
  tag gid: 'AMZL-23-230246'
  tag rid: 'AMZL-23-230246r627750_rule'
  tag stig_id: 'AMZL-23-010220'
