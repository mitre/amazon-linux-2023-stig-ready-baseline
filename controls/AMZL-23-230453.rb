control 'AMZL-23-230453' do
  title "Successful/unsuccessful uses of the ftruncate command in Amazon Linux 2023 must
...
auid!=unset -k perm_access
  ...
  tag gid: 'AMZL-23-230453'
  tag rid: 'AMZL-23-230453r627750_rule'
  tag stig_id: 'AMZL-23-030460'
