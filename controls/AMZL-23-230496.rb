control 'AMZL-23-230496' do
  title 'Amazon Linux 2023 must disable the stream control transmission protocol (SCTP).'
...
Reboot the system for the settings to take effect.'
  ...
  tag gid: 'AMZL-23-230496'
  tag rid: 'AMZL-23-230496r792917_rule'
  tag stig_id: 'AMZL-23-040023'
