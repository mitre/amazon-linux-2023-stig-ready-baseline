control 'AMZL-23-230293' do
  title 'Amazon Linux 2023 must use a separate file system for /var/log.'
...
the following command:
  ...
  tag gid: 'AMZL-23-230293'
  tag rid: 'AMZL-23-230293r627750_rule'
  tag stig_id: 'AMZL-23-010541'
