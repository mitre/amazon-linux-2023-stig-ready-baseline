control 'AMZL-23-230367' do
  title 'Amazon Linux 2023 user account passwords must be configured so that existing
...
lifetime restriction.
  ...
  tag gid: 'AMZL-23-230367'
  tag rid: 'AMZL-23-230367r627750_rule'
  tag stig_id: 'AMZL-23-020210'
