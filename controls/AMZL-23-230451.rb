control 'AMZL-23-230451' do
  title "Successful/unsuccessful uses of the open system call in Amazon Linux 2023 must
...
auid!=unset -k perm_access
  ...
  tag gid: 'AMZL-23-230451'
  tag rid: 'AMZL-23-230451r627750_rule'
  tag stig_id: 'AMZL-23-030440'
