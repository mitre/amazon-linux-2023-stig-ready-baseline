control 'AMZL-23-230469' do
  title 'Amazon Linux 2023 must allocate an audit_backlog_limit of sufficient size to
...
system is susceptible to boot failures and crashes.'
  desc 'check', 'Verify Amazon Linux 2023 allocates a sufficient audit_backlog_limit to capture
...
commented out, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to allocate sufficient audit_backlog_limit to capture
...
configuration survives kernel updates:
  ...
  tag gid: 'AMZL-23-230469'
  tag rid: 'AMZL-23-230469r744004_rule'
  tag stig_id: 'AMZL-23-030602'
