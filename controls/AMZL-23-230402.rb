control 'AMZL-23-230402' do
  title 'Amazon Linux 2023 audit system must protect auditing rules from unauthorized
change.'
...
is recommended to add this option as the last step in securing the system.'
  ...
  tag gid: 'AMZL-23-230402'
  tag rid: 'AMZL-23-230402r627750_rule'
  tag stig_id: 'AMZL-23-030121'
