control 'AMZL-23-230492' do
  title 'Amazon Linux 2023 must not have the rsh-server package installed.'
...
removing the rsh-server package from the system with the following command:
  ...
  tag gid: 'AMZL-23-230492'
  tag rid: 'AMZL-23-230492r627750_rule'
  tag stig_id: 'AMZL-23-040010'
