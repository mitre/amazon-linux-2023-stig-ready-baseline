control 'AMZL-23-244545' do
  title 'The Amazon Linux 2023 fapolicy module must be enabled.'
...
not namespace aware and can cause issues when launching or running containers.'
  desc 'check', 'Verify the Amazon Linux 2023 "fapolicyd" is enabled and running with the following
command:
...
$ sudo systemctl enable --now fapolicyd'
  ...
  tag gid: 'AMZL-23-244545'
  tag rid: 'AMZL-23-244545r743884_rule'
  tag stig_id: 'AMZL-23-040136'
