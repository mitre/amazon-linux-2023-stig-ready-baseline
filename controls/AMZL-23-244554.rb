control 'AMZL-23-244554' do
  title 'Amazon Linux 2023 must enable hardening for the Berkeley Packet Filter
...
enables JIT hardening for all users.'
  desc 'check', 'Verify Amazon Linux 2023 enables hardening for the BPF JIT with the following commands:
...
returned, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to enable hardening for the BPF JIT compiler by adding the
...
effect. To reload the contents of the files, run the following command:
  ...
  tag gid: 'AMZL-23-244554'
  tag rid: 'AMZL-23-244554r743911_rule'
  tag stig_id: 'AMZL-23-040286'
