control 'AMZL-23-230224' do
  title 'All Amazon Linux 2023 local disk partitions must implement cryptographic
mechanisms to prevent unauthorized disclosure or modification of all
information that requires at rest protection.'
  desc 'Amazon Linux 2023 systems handling data requiring "data at rest" protections
...
data structures (e.g., files, records, or fields).'
  desc 'check', 'Verify Amazon Linux 2023 prevents unauthorized disclosure or modification of all
...
encrypted, this is a finding.'
  desc 'fix', 'Configure Amazon Linux 2023 to prevent unauthorized modification of all information at
...
entire partition, dedicate a partition for encryption in the partition layout.'
  ...
  tag gid: 'AMZL-23-230224'
  tag rid: 'AMZL-23-230224r627750_rule'
  tag stig_id: 'AMZL-23-010030'
